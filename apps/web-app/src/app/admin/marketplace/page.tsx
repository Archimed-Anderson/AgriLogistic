    ...
    <div className="p-8 space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-black text-slate-900 tracking-tight mb-2">
            Marketplace <span className="text-emerald-600">Manager</span>
          </h1>
          <p className="text-slate-500 font-medium">
            Gérez votre catalogue de produits, les stocks et les prix en temps réel.
          </p>
        </div>
        <Button
      ...
      <div className="bg-white p-4 rounded-3xl border border-slate-100 shadow-sm flex flex-col md:flex-row items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button
            variant="outline"
            className="rounded-2xl h-12 px-6 flex items-center gap-2 font-bold border-slate-100 text-slate-600"
          >
            ...
            <tbody className="divide-y divide-slate-50">
              {filteredProducts.map((product) => (
                <tr key={product.id} className="hover:bg-slate-50/50 transition-colors group">
                  ...
                  <td className="px-6 py-4 font-bold text-slate-700 text-sm">{product.stock}</td>
                  <td className="px-6 py-4">
                    {product.stock > 10 ? (
            ...
            <div className="flex items-center justify-between mb-8 pb-6 border-b border-slate-50">
              <div>
                ...
                <p className="text-slate-500 text-sm font-medium">
                  Entrez les détails officiels du produit pour la marketplace.
                </p>
              </div>
              <button
                onClick={() => setIsModalOpen(false)}
