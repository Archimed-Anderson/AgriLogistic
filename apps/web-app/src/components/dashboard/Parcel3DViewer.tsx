        ...
        <DreiHtml distanceFactor={10} position={[0, 0.8, 0]} center zIndexRange={[10, 0]}>
          ...
          >
            <div className="flex items-center justify-between mb-3">
              <p className="text-[10px] font-black uppercase text-[#D4A017] tracking-tighter">
                {label}
              </p>
              <Badge className="bg-emerald-500/20 text-emerald-400 border-none text-[8px]">
                LIVE
              </Badge>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-[9px] text-white/40 flex items-center gap-1 uppercase font-bold">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[11px] font-black uppercase text-[#D4A017] tracking-[0.3em]">
                  ANALYSE AUGMENTÉE
                </span>
              </div>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-end">
                  <span className="text-[10px] font-black text-white/40 uppercase tracking-widest">
                    Index Végétatif NDVI
                  </span>
                  <span
                    className={`text-sm font-black tracking-tighter ${ndviValue > 75 ? 'text-emerald-400' : ndviValue > 40 ? 'text-amber-400' : 'text-red-400'}`}
                  >
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="bg-white/5 p-4 rounded-2xl border border-white/5 group hover:border-[#D4A017]/30 transition-all">
                  ...
                  <p className="text-xs font-black text-white">
                    82% <span className="text-[10px] text-emerald-400 ml-1">↑</span>
                  </p>
                </div>
                <div className="bg-white/5 p-4 rounded-2xl border border-white/5 group hover:border-[#D4A017]/30 transition-all">
                  ...
                  <p className="text-xs font-black text-white">
                    4.2 <span className="text-[10px] text-white/40 ml-1">avg</span>
                  </p>
                </div>
              </div>
            </div>
