  ...
  return (
    <div className="relative w-full aspect-square max-w-[650px] mx-auto flex items-center justify-center p-4">
      ...
      <div className="absolute -bottom-8 left-0 right-0 flex justify-center gap-6">
        ...
        <div
          className="px-5 py-2.5 rounded-full bg-blue-50 border border-blue-100 text-blue-700 text-[12px] font-black uppercase tracking-wider flex items-center gap-2 shadow-lg animate-float"
