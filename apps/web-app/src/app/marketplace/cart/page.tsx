      ...
      <div className="min-h-screen bg-[#F8F9FA]">
        ...
        <main className="container mx-auto px-6 pt-40 pb-20">
          <div className="max-w-xl mx-auto text-center bg-white p-12 rounded-[3rem] shadow-sm border border-slate-100">
            ...
            <h1 className="text-4xl font-black text-slate-900 mb-4 tracking-tight">Votre panier est vide</h1>
            <p className="text-slate-500 font-medium mb-10 leading-relaxed">
              Il semble que vous n'ayez pas encore ajouté de produits. Explorez notre marketplace pour découvrir des pépites !
            </p>
      ...
      <main className="container mx-auto px-6 pt-40 pb-20">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1 space-y-8">
            ...
            <Link href="/marketplace" className="inline-flex items-center text-slate-400 hover:text-emerald-600 font-bold transition-colors group">
          ...
          <aside className="lg:w-[400px] space-y-6">
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm sticky top-32">
              <h2 className="text-2xl font-black text-slate-900 mb-8 tracking-tight">Récapitulatif</h2>
              ...
              <div className="space-y-6 mb-10">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-black text-emerald-600">{finalTotal.toLocaleString()} FCFA</span>
                </div>
              </div>
            ...
            <div className="bg-emerald-600 p-8 rounded-[2.5rem] text-white relative overflow-hidden group">
               <div className="relative z-10">
                 ...
                 <p className="text-emerald-100 text-sm font-medium mb-6">Ajoutez-le à l'étape suivante pour profiter de -10%.</p>
                 <div className="flex gap-2">
                    ...
                    />
                    <button className="px-6 bg-white text-emerald-600 rounded-xl font-black text-xs uppercase">Appliquer</button>
                 </div>
               </div>
