...
const caseStudies = [
  {
    ...
    title: "Une bouée de sauvetage numérique pour les agriculteurs : Comment AgroLogistic a construit la résilience climatique en Afrique de l'Ouest",
  ...
  },
  {
    ...
    title: "Intégration des données pour des insights en temps réel : produire des semences résilientes pour un impact mondial",
  ...
  },
  {
    id: 7,
    tag: "Intelligence Agricole",
    title: "Maximiser le rendement grâce à l'intelligence prédictive et aux solutions de télédétection",
      ...
      <section className="py-24 px-6 bg-[#002C17] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <p className="text-gray-300 text-xl max-w-3xl mx-auto leading-relaxed">
            Découvrez comment les entreprises, les sociétés alimentaires et les gouvernements 
            ont atteint efficacité, conformité et durabilité avec nos solutions.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-2 mt-16">
            ...
            <button className="w-10 h-10 rounded-full bg-white border border-gray-200 text-gray-600 hover:border-[#79C25C] transition-colors">2</button>
            <button className="w-10 h-10 rounded-full bg-white border border-gray-200 text-gray-600 hover:border-[#79C25C] transition-colors">3</button>
            <span className="mx-2 text-gray-400">...</span>
            <button className="w-10 h-10 rounded-full bg-white border border-gray-200 text-gray-600 hover:border-[#79C25C] transition-colors">5</button>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-[#002C17] text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-lg mb-10 max-w-2xl mx-auto">
            Rejoignez les entreprises leaders qui transforment leur agriculture avec nos solutions innovantes.
          </p>
          <button 
