# AgroDeep API Gateway

Kong-based API Gateway for the AgroDeep microservices platform.
...
2. ⏭️ Implement Authentication Service (Week 3-4)
3. ⏭️ Implement Product Service (Week 5-6)
4. ⏭️ Implement Order Service (Week 7-8)
5. ⏭️ Implement Payment Service (Week 9-10)
