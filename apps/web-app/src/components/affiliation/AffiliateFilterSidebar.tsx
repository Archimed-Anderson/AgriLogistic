  ...
  return (
    <div className="space-y-8 bg-[#1a1a1a] backdrop-blur-xl border-2 border-white/5 p-6 rounded-2xl">
      ...
      <div className="space-y-4">
        <div className="text-[10px] font-black text-slate-500 uppercase tracking-widest pl-2 mb-2">
          Catégories
        </div>
                ...
                <div className="flex items-center gap-3">
                  <Icon
                    className={cn(
                      ...
                      selectedPlatform === plat.id
                        ? 'text-yellow-500'
                        : 'text-slate-500 group-hover:text-yellow-500'
                    )}
                  />
      ...
      <div className="relative mt-8 group cursor-pointer hover:scale-105 transition-transform duration-300">
        ...
        <div className="relative p-5 bg-[#242424] border-2 border-white/5 group-hover:border-yellow-500/50 rounded-2xl text-center overflow-hidden">
          ...
          <div className="bg-yellow-500 text-black text-[10px] font-black px-2 py-1 rounded-full w-fit mx-auto mb-3 uppercase shadow-lg shadow-yellow-500/20">
            Offre Premium
          </div>
          ...
          <p className="text-slate-400 text-[10px] font-bold mb-4">
            Gagnez jusqu'à 15% de commission sur vos recommandations.
          </p>
