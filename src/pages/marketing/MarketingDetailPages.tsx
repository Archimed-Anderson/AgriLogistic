    ...
    <DetailPage
      ...
      content={
        <>
          ...
          <p>
            Have a question about our platform, services, or pricing? Our team is ready to provide
            you with the answers you need to get started.
          </p>
    ...
    <DetailPage
      ...
      content={
        <>
          ...
          <p>
            Facing a technical issue? Our dedicated support engineers are here to ensure your
    ...
    <DetailPage
      ...
      content={
        <>
          <h2>Grow With Us</h2>
          <p>
            We are always looking to collaborate with organizations that share our vision for a
            sustainable agricultural future. Let's build something great together.
          </p>
    ...
    <DetailPage
      ...
      content={
        <>
          ...
          <p>
            We believe that high-yield agriculture shouldn't come at the cost of the environment.
            Our eco-friendly practices focus on regenerative agriculture, ensuring soil health and
            biodiversity are maintained.
          </p>
          <h3>Key Synergies</h3>
          <ul>
            <li>
              Regenerative Soil Management: Using cover crops and composting to sequester carbon.
            </li>
            <li>
              Integrated Pest Management (IPM): Reducing pesticide use by introducing natural
              predators.
            </li>
    ...
    <DetailPage
      ...
      content={
        <>
          ...
          <p>
            AgroLogistic cuts out the middlemen, connecting smallholder farmers directly to global
            buyers. This ensures fairer prices, transparent transactions, and faster payments.
          </p>
    ...
    <DetailPage
      ...
      content={
        <>
          ...
          <p>
            Our AI-driven analytics platform processes millions of data points daily to provide
            actionable insights. This allows farmers to optimize planting schedules, nutrient
...
export function PracticesWaterEfficiencyPage({
  onNavigate,
}: {
  onNavigate: (route: string) => void;
}) {
    ...
    <DetailPage
      ...
      content={
        <>
          ...
          <p>
            With precision irrigation powered by IoT sensors and predictive models, AgroLogistic
            helps farms reduce water waste while improving crop quality.
          </p>
          <h3>What you get</h3>
          <ul>
...
export function PracticesRenewableEnergyPage({
  onNavigate,
}: {
  onNavigate: (route: string) => void;
}) {
    ...
    <DetailPage
      ...
      content={
        <>
          ...
          <p>
            AgroLogistic supports farm electrification strategies and energy monitoring to reduce
    ...
    <DetailPage
      ...
      content={
        <>
          ...
          <p>
            A full transformation program supported by data-driven agronomy, marketplace access and
...
export function ProjectSmartIrrigationPage({
  onNavigate,
}: {
  onNavigate: (route: string) => void;
}) {
    ...
    <DetailPage
      ...
      content={
        <>
          ...
          <p>
            IoT sensor deployment, analytics and automation workflows combined to increase yields
...
export function ProjectLogisticsPage({ onNavigate }: { onNavigate: (route: string) => void }) {
  ...
  const capabilities = [
    {
      ...
      content:
        "L'analytique prédictive des rendements d'AgroLogistic est reconnue parmi les meilleures solutions pour l'optimisation de la supply chain en agriculture. Elle exploite des données avancées et des modèles prédictifs pilotés par l'IA pour prévoir avec précision la production des cultures. Cela permet aux responsables des achats et de la supply chain de planifier de manière proactive, de réduire les risques, d'améliorer l'efficacité de l'approvisionnement et d'assurer une traçabilité avec une visibilité cohérente sur les rendements.",
    },
    {
      title: 'Intelligence Climatique & Météo',
      content:
        "Notre module d'intelligence climatique offre des prévisions hyper-locales et des alertes en temps réel sur les événements météorologiques extrêmes. En intégrant ces données aux cycles de vie des cultures, nous permettons une adaptation agile des stratégies logistiques pour minimiser les pertes et sécuriser l'approvisionnement face aux aléas climatiques.",
    },
    {
      title: 'Prédiction Qualité & Durée de Vie',
      content:
        "Grâce à des algorithmes d'apprentissage automatique analysant les conditions de récolte et de transport, nous prédisons la qualité et la durée de conservation des produits. Cela permet une distribution intelligente : les produits à durée de vie courte sont priorisés pour les marchés locaux, réduisant ainsi le gaspillage alimentaire.",
    },
    {
      title: 'Traçabilité & Provenance',
      content:
        "Assurez une transparence totale de la ferme à la table. Notre système de traçabilité blockchain garantit l'authenticité de l'origine, certifie les pratiques durables et renforce la confiance des consommateurs grâce à des données vérifiables à chaque étape de la chaîne de valeur.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
        ...
        <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold leading-tight mb-6">
              Plateforme d'Intelligence <span className="text-[#79C25C]">Supply Chain</span>{' '}
              alimentée par l'IA
            </h1>
            <p className="text-gray-300 text-lg mb-8 leading-relaxed">
              Naviguez dans la volatilité de la chaîne d'approvisionnement avec des prévisions
              guidées par l'IA, une intelligence régionale et une atténuation intelligente des
              risques pour sécuriser votre écosystème d'approvisionnement.
            </p>
      ...
      <section
        className="py-20 px-6 relative overflow-hidden text-white"
        style={{ backgroundColor: '#002C17' }}
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              Le manuel d'approvisionnement traditionnel n'a jamais été conçu pour les réalités
              d'aujourd'hui. Les crises climatiques, les maladies des cultures, les retards
              d'expédition et les tensions géopolitiques réécrivent les règles, laissant les
              détaillants alimentaires vulnérables.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center gap-4 bg-white/10 rounded-full px-6 py-4 hover:bg-white/20 transition-colors"
                  >
            ...
            <div>
              <h3 className="font-bold text-xl mb-8 leading-relaxed">
                AgroLogistic fournit une intelligence basée sur les données sur le potentiel de
                rendement, vous donnant des informations exploitables pour :
              </h3>
              <div className="space-y-4">
                {[
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#F0FDF4] p-8 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed text-sm">
                Avec les signaux précoces, les responsables de la supply chain accèdent à des
                informations clés sur la production avec des données en temps réel sur les champs,
                la météo et la santé des cultures. Cela améliore la traçabilité avec une meilleure
                visibilité et permet une planification proactive.
              </p>
            </div>
            ...
            <div className="bg-[#F0FDF4] p-8 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <h3 className="font-bold text-xl text-[#002C17] mb-4">Scores de Risque Régionaux</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
                Les scores de risque aident à évaluer les menaces potentielles liées à la météo, aux
                ravageurs ou aux problèmes socio-politiques. Cela ajoute une couche prédictive à la
                gestion de la supply chain, permettant d'atténuer les risques et de prendre des
                décisions éclairées sur les zones vulnérables.
              </p>
            </div>
            ...
            <div className="bg-[#F0FDF4] p-8 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <h3 className="font-bold text-xl text-[#002C17] mb-4">Prévision des Volumes</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
                La prévision des volumes prédit la disponibilité future des cultures via l'analyse
                de données et les tendances historiques. Cela renforce la gestion des stocks,
                soutient les stratégies d'approvisionnement et assure des livraisons ponctuelles à
                travers le cadre de traçabilité.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-7 grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Une expertise éprouvée dans l'alimentation des opérations d'approvisionnement et
                  de supply chain pour les plus grandes marques de distribution et de CPG au monde.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Opérations à l'épreuve des intempéries avec détection des stades de culture,
                  prévisions basées sur l'IA et alertes de risques hyperlocales.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Planifiez précisément les achats, protégez vos marges grâce à une tarification
                  cohérente, optimisez la qualité et la durée de vie.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Alignez la planification des récoltes avec les modèles de maturité des cultures
                  (GDD) pour optimiser la logistique et la gestion de la chaîne du froid.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Permet des décisions plus intelligentes à tous les niveaux, aidant les
                  organisations à prospérer malgré la volatilité du marché.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Alignez les décisions avec les objectifs réglementaires et environnementaux, et
                  suivez les émissions, l'utilisation de l'eau et la déforestation.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Nous aidons les distributeurs alimentaires avec des logiciels de traçabilité pour
                l'industrie alimentaire, garantissant une livraison ponctuelle et l'intégrité des
                produits. La visibilité et l'analytique améliorées permettent une gestion des stocks
                fluide et une logistique optimisée.
              </p>
            </div>
            ...
            <div className="group">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                AgroLogistic équipe les entreprises agrochimiques et d'intrants avec une
                intelligence en temps réel au niveau parcellaire pour optimiser les opérations,
                augmenter les ventes et assurer la conformité tout en analysant les performances
                sous divers climats et sols.
              </p>
            </div>
            ...
            <div className="group">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                AgroLogistic permet aux détaillants alimentaires d'améliorer la traçabilité et la
                transparence de la chaîne d'approvisionnement, avec des produits frais de haute
                qualité. Nous aidons à réduire le gaspillage et optimiser les stratégies
                d'approvisionnement avec des données fiables.
              </p>
            </div>
            ...
            <div className="group">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Nous permettons aux fabricants de biens de consommation d'améliorer leur
                planification de production et leur contrôle qualité via une intelligence
                actionnable. Cela permet une meilleure gestion de la chaîne d'approvisionnement avec
              ...
              <div className="relative rounded-2xl overflow-hidden h-72 shadow-lg group-hover:shadow-xl transition-shadow">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <p className="text-white font-medium text-lg leading-snug">
                    Maximiser le rendement grâce à l'intelligence prédictive et aux solutions de
                    télédétection
                  </p>
                </div>
              </div>
      ...
      <section className="py-24 bg-gray-50 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-1/3 h-full opacity-5 pointer-events-none">
          <img
            src="/assets/images/landing/smart-warehouse.png"
            className="w-full h-full object-cover grayscale"
            alt="Warehouse Pattern"
          />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Avantages Clés pour Nos Clients
            </h2>
            <div className="w-20 h-1 bg-[#79C25C] mx-auto mb-8"></div>
            <p className="text-gray-600 mb-8">
              Notre plateforme cloud permet une transformation complète de votre chaîne
              d'approvisionnement grâce à des données précises.
            </p>
            ...
            <div className="rounded-2xl overflow-hidden shadow-xl mb-12 border border-gray-200">
              ...
              <div className="bg-white p-4 text-left border-t border-gray-100 flex items-center justify-between">
                ...
                <span className="text-sm text-[#79C25C] font-semibold tracking-wider uppercase">
                  Future Ready
                </span>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: 'Achats Plus Intelligents',
                icon: TrendingUp,
                desc: 'Planifiez mieux, sécurisez les marges et assurez la qualité avec des insights prédictifs sur les récoltes.',
              },
              {
                title: 'Logistique Optimisée',
                icon: Truck,
                desc: 'Modèles de maturité des cultures pour aligner parfaitement la logistique avec les périodes de récolte.',
              },
              {
                title: 'Résilience des Données',
                icon: ShieldCheck,
                desc: 'Prenez des décisions éclairées malgré la volatilité des marchés et les perturbations climatiques.',
              },
              {
                title: 'Suivi Durabilité',
                icon: Leaf,
                desc: 'Surveillez et rapportez les métriques de durabilité pour répondre aux exigences réglementaires.',
              },
            ].map((item, i) => (
              <div
                key={i}
                className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 group border border-transparent hover:border-[#79C25C]/30"
              >
