...
export const metadata: Metadata = {
  ...
  description:
    'Découvrez notre sélection de meilleurs outils, capteurs et équipements industriels recommandés par nos experts. Prix Amazon et Alibaba garantis.',
  ...
  return (
    <div className="relative min-h-screen text-white">
      ...
      <div className="absolute top-0 left-0 w-full h-screen -z-10 overflow-hidden pointer-events-none">
        <Lazy3DBackground className="absolute inset-0 w-full h-full" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-3 bg-orange-600/10 border border-orange-600/30 px-6 py-2 rounded-full mb-10 animate-pulse shadow-[0_0_40px_rgba(234,88,12,0.1)]">
              ...
              <span className="text-orange-500 font-black uppercase text-[10px] tracking-[0.3em]">
                Promotions Flash Actives
              </span>
            ...
            <p className="text-slate-400 text-lg md:text-xl font-bold max-w-2xl mx-auto mb-16 leading-relaxed italic">
              Nous sélectionnons pour vous les équipements les plus robustes au meilleur prix chez
              nos partenaires mondiaux.{' '}
              <span className="text-yellow-500 font-black">Expertise Industrielle incluse.</span>
            </p>
      ...
      <section className="py-32 bg-gradient-to-t from-yellow-500/10 to-transparent border-t border-white/5 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <h3 className="text-5xl font-black uppercase italic mb-8 tracking-tighter">
            Un besoin spécifique ?
          </h3>
          <p className="text-slate-400 font-bold mb-12 max-w-lg mx-auto text-lg leading-relaxed">
            Nos experts peuvent sourcer du matériel sur-mesure pour vos besoins industriels les plus
            extrêmes.
          </p>
