...
import { Users, History, ShieldCheck, Zap, LayoutGrid, ArrowRight } from 'lucide-react';
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl text-sm leading-relaxed font-medium">
            Console de supervision et de contrôle d'accès. Gérez l'impersonation, les permissions
            granulaires et consultez l'historique immutable des actions administratives.
          </p>
        </div>
      ...
      <Tabs defaultValue="directory" className="w-full space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <Button
              variant="outline"
              className="rounded-2xl border-border bg-card/40 h-12 px-6 gap-2 text-[10px] font-black uppercase tracking-widest shadow-lg"
            >
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h4 className="text-sm font-black text-foreground uppercase tracking-tight">
              Mise à jour des Politiques RBAC
            </h4>
            <p className="text-[10px] text-muted-foreground font-black uppercase tracking-widest mt-1">
              Les modifications de privilèges sont appliquées de manière atomique à travers le
              cluster AgriLogistic.
            </p>
          </div>
        </div>
