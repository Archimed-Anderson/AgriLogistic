    ...
    <div className="max-w-[1400px] mx-auto p-4 md:p-8 space-y-10 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <Button
            variant="outline"
            className="rounded-xl border-border bg-card/40 h-11 px-6 gap-2 text-[10px] font-black uppercase tracking-widest shadow-lg hover:bg-accent transition-all"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        {[
          ...
          <Card
            key={kpi.label}
            className="border-border bg-card/40 backdrop-blur-xl rounded-[20px] overflow-hidden hover:shadow-xl hover:shadow-primary/5 transition-all group"
          >
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <span
                  className={`text-[10px] font-bold ${
                    kpi.trend.startsWith('+') ? 'text-emerald-500' : 'text-blue-500'
                  }`}
                >
                  {kpi.trend}
                </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card className="border-border bg-card/40 backdrop-blur-xl rounded-[32px] overflow-hidden">
          <CardHeader className="p-8 pb-4">
            <CardTitle className="text-[12px] font-black uppercase tracking-[0.3em] text-muted-foreground">
            ...
            <div className="h-[350px] w-full rounded-2xl bg-muted/20 border border-border/50 flex flex-col items-center justify-center space-y-4">
              <div className="flex items-center gap-1">
                {[40, 70, 45, 90, 65].map((h, i) => (
                  <div
                    key={i}
                    className="w-3 bg-primary/40 rounded-t-sm animate-pulse"
        ...
        <Card className="lg:col-span-2 border-border bg-card/40 backdrop-blur-xl rounded-[32px] overflow-hidden">
          <CardHeader className="p-8 pb-4 flex flex-row items-center justify-between">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="text-[10px] font-black uppercase underline decoration-primary underline-offset-4"
            >
              Voir Rapport
            </Button>
          </CardHeader>
          <CardContent className="p-8 pt-0">
            <div className="space-y-6">
              {[
                ...
                {
                  name: 'Salades Batavias Fraîches',
                  count: 743,
                  growth: '+22%',
                  status: 'In Stock',
                },
            ...
            <div className="space-y-8">
              ...
              <div className="mt-8 p-4 rounded-2xl bg-primary/5 border border-primary/20">
                ...
                <p className="text-[11px] font-medium text-muted-foreground leading-relaxed">
                  La production légumière maintient une croissance constante de{' '}
                  <span className="text-primary font-bold">12%</span> ce mois-ci. Optimisation
                  logistique recommandée pour le secteur arboriculture.
                </p>
              </div>
            </div>
          </CardContent>
