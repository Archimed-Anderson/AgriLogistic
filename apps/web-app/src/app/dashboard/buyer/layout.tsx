  ...
  return (
    <div className="flex h-screen bg-slate-950 text-slate-300 font-mono overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-[url('/grid-pattern.svg')]">
        ...
        <header className="h-14 border-b border-slate-800 bg-slate-950/80 backdrop-blur flex items-center justify-between px-6 z-40">
          ...
          <div className="flex items-center gap-6 ml-4">
            ...
            <Button
              variant="ghost"
              size="icon"
              className="relative hover:bg-slate-800 text-slate-400"
            >
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className="flex items-center gap-2 pl-2 pr-1 hover:bg-slate-800 rounded-lg"
                >
        ...
        {/* Content Scrollable */}
        <main className="flex-1 overflow-auto p-6 scroll-smooth custom-scrollbar">{children}</main>
      </div>
    </div>
  );
}
