...
# JWT Configuration
JWT_ACCESS_SECRET=agrodeep_secure_jwt_access_secret_2026_change_in_production
JWT_REFRESH_SECRET=agrodeep_secure_jwt_refresh_secret_2026_change_in_production
...
"@
        ...
        $dbPassword = Read-Host "Mot de passe PostgreSQL (ou appuyez sur Entrée pour 'agrodeep_password')"
        if ([string]::IsNullOrWhiteSpace($dbPassword)) {
            $dbPassword = "agrodeep_password"
        }
