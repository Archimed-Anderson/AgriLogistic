...
export const affiliateProducts: AffiliateProduct[] = [
  ...
  // ==========================================
  {
    ...
    description: 'Une machine puissante et endurante pour tous les travaux de vissage et perçage intensifs en milieu agricole ou atelier.',
    images: [
    ...
    seo: {
      ...
      metaDescription: 'Achetez la perceuse Bosch GSB 18V-55 au meilleur prix. Test et avis complet sur AgriLogistic.',
  ...
  },
  {
    ...
    description: 'Ensemble d\'outils en acier Chrome Vanadium conçu pour durer dans les environnements difficiles.',
    images: [
    ...
    affiliateUrl: 'https://www.alibaba.com/product-detail/High-Quality-120Pcs-Socket-Set_123456789.html',
    seo: {
      title: 'Kit Outils 120 Pièces Alibaba - Import Direct | AgriLogistic',
      metaDescription: 'Kit outils complet pour maintenance agricole via Alibaba. Robuste et économique.',
  ...
  },
  {
    ...
    seo: {
      ...
      metaDescription: 'Découvrez la tronçonneuse Echo CS-2511WES. Légère et puissante pour l\'élagage.',
  ...
  // ==========================================
  {
    ...
    description: 'Suivez en temps réel le vent, la pluie, l\'humidité et l\'ensoleillement sur votre smartphone.',
    images: [
      'https://images.unsplash.com/photo-1590053132232-6bc9d89a067a?q=80&w=800'
    ],
  ...
  },
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1584033519782-96944694295d?q=80&w=800'
    ],
    ...
    affiliateUrl: 'https://www.alibaba.com/product-detail/Smart-Agriculture-Soil-Moisture-Sensor_LORA.html',
    seo: {
      title: 'Capteur Humidité LoRaWAN - Agri Connectée | AgriLogistic',
      metaDescription: 'Surveillez l\'humidité de vos sols avec la technologie LoRaWAN. Idéal grandes surfaces.',
  ...
  // ==========================================
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1590486803833-2c709d21e3ca?q=80&w=800'
    ],
    ...
    affiliateUrl: 'https://www.alibaba.com/product-detail/3-Inch-High-Pressure-Diesel-Water_PUMP.html',
    seo: {
      title: 'Motopompe Diesel 3" - Irrigation Puissante | AgriLogistic',
      metaDescription: 'Motopompe diesel haute performance pour irrigation agricole. Robuste et économique.',
  ...
  },
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1621905252507-b35482cdca4b?q=80&w=800'
    ],
    ...
    seo: {
      ...
      metaDescription: 'Ne tombez jamais en panne avec le générateur Hyundai. Puissance et fiabilité.',
  ...
  },
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1592819695396-0661b1260d0c?q=80&w=800'
    ],
  ...
  },
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1589923188900-85dae525524c?q=80&w=800'
    ],
    ...
    affiliateUrl: 'https://www.alibaba.com/product-detail/16L-Battery-Operated-Electric-Knapsack-Sprayer_PULV.html',
    seo: {
...
export const getAffiliateProductById = (id: string) => 
  affiliateProducts.find(p => p.id === id)
