       ...
       <div className="flex items-center justify-between shrink-0">
          <div className="flex items-center gap-4">
             ...
             <div className="flex gap-2">
                <Button variant="outline" size="sm" className="bg-slate-950/50 border-white/10 text-slate-400 hover:text-white rounded-lg h-10 text-[10px] uppercase font-bold">
          ...
          <div className="absolute top-6 right-6 z-10 flex flex-col gap-3 pointer-events-none">
             {[
               ...
               { label: "CO2 Économisé", val: "-420kg", col: "blue", icon: Fuel },
                ...
                <div key={i} className="bg-slate-950/80 backdrop-blur-md border border-white/10 p-4 rounded-2xl w-48 shadow-lg flex items-center justify-between pointer-events-auto hover:scale-105 transition-transform">
                   <div>
                   ...
                   <div className={`h-8 w-8 rounded-lg bg-${kpi.col}-500/10 flex items-center justify-center text-${kpi.col}-500`}>
                      <kpi.icon size={16} />
                   </div>
                </div>
             ))}
          ...
          <div className="absolute bottom-0 left-0 right-0 z-10 bg-gradient-to-t from-slate-950 via-slate-950/80 to-transparent p-6 pt-24 pointer-events-none">
             <div className="flex items-end justify-between mb-4 pointer-events-auto">
                <div className="flex items-center gap-2">
                   ...
                   <span className="text-xs font-black text-white uppercase tracking-widest">Opportunités Identifiées par IA</span>
                </div>
             </div>
