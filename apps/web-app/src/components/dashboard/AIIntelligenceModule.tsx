      ...
      <CardContent className="p-10 h-[450px] relative">
        <div className="absolute inset-x-10 top-10 flex justify-between z-10">
          ...
          <div className="p-4 bg-[#D4A017]/10 backdrop-blur-md rounded-2xl border border-[#D4A017]/20">
            <p className="text-[8px] font-black text-[#D4A017]/60 uppercase tracking-widest mb-1">
              CIBLE PRÉVUE (AUG)
            </p>
              ...
              content={({ active, payload }) => {
                if (active && payload && payload.length) {
                  ...
                  return (
                    ...
                    >
                      <div className="flex justify-between items-center">
                        <p className="text-[#D4A017] uppercase text-[10px] font-black tracking-widest">
                          {data.month}
                        </p>
                        <Badge
                          className={cn(
                            'text-[8px] font-black px-2',
                            isPrediction ? 'bg-[#D4A017] text-black' : 'bg-white/10'
                          )}
                        >
                      ...
                      <div>
                        <p className="text-white text-3xl font-black tracking-tighter">
                          {isPrediction ? data.prediction : data.history}{' '}
                          <span className="text-sm text-white/40 font-bold uppercase">Tonnes</span>
                        </p>
                      </div>
...
function AIAdvisorChat() {
  const [messages, setMessages] = React.useState([
    {
      role: 'assistant',
      content:
        "Agent Core opérationnel. Je synchronise les données environnementales de vos 4 parcelles... Comment puis-je optimiser vos cycles aujourd'hui ?",
    },
  ]);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      let response =
        "Analyse terminée. L'indice NDVI de la parcelle SUD indique un stress hydrique de 12%. Recommandation : Irrigation ciblée de 14h à 18h.";
      if (
        input.toLowerCase().includes('pluie') ||
        input.toLowerCase().includes('pleut') ||
        input.toLowerCase().includes('météo')
      ) {
        response =
          "ALERTE MÉTÉO : Orages prévus dans 45min. J'ai préventivement sécurisé les vannes de la zone B. Vérifiez l'évacuation des fossés.";
      }
    ...
    <Card className="border-none bg-white dark:bg-[#0a1f18] shadow-3xl rounded-[3rem] flex flex-col h-[700px] overflow-hidden border border-slate-100 dark:border-white/5">
      <CardHeader className="p-10 border-b border-slate-50 dark:border-white/5 bg-slate-50/50 dark:bg-white/2 relative">
        <div className="flex items-center gap-6">
          ...
          <div>
            <CardTitle className="text-xl font-black tracking-widest uppercase text-[#1B4D3E] dark:text-white">
              AGRO-BOT V4
            </CardTitle>
            <div className="flex items-center gap-2 mt-1">
              <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
              <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">
                Latence: 24ms // SSL Sécurisé
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex gap-4">
            ...
            <div className="bg-slate-50 dark:bg-white/5 p-6 rounded-[2rem] rounded-tl-none flex gap-2 border border-slate-100 dark:border-white/5">
              <motion.div
                ...
                className="h-2 w-2 bg-[#D4A017] rounded-full"
              />
              <motion.div
                animate={{ y: [0, -5, 0] }}
              ...
              <div
                className={cn(
                  ...
                  i + 1 < step
                    ...
                    : i + 1 === step
                      ? 'bg-[#D4A017] border-[#D4A017] shadow-2xl shadow-[#D4A017]/30 scale-110'
                      : 'border-white/10'
                )}
              >
                <s.icon
                  className={cn('h-6 w-6', i + 1 <= step ? 'text-black dark:text-white' : '')}
                />
              </div>
            ...
            >
              ...
              <div className="text-center space-y-2">
                <p className="text-xl font-black uppercase tracking-tighter">
                  SIMULATION DES CYCLES Culturels
                </p>
                <p className="text-white/30 font-bold text-[10px] uppercase tracking-widest">
                  Analyse de 1.4M de points de données environnementales...
                </p>
              </div>
            </motion.div>
          ) : (
              ...
              >
                <div className="space-y-4 text-center">
                  ...
                  <p className="text-white/40 font-bold text-sm">
                    Précisez la composition du substrat pour optimiser les nutriments.
                  </p>
                </div>
          ...
          {step === 2 && !isProcessing && (
            ...
            >
              <div className="space-y-4 text-center">
                ...
                <p className="text-white/40 font-bold text-sm">
                  Déterminez le budget d'intrants et de monitoring requis.
                </p>
              </div>
              <div className="space-y-16 py-12 px-4 bg-white/2 rounded-[3.5rem] border border-white/5 shadow-inner">
                ...
                <div className="flex justify-between items-end">
                  ...
                  <div className="text-center group-hover:scale-110 transition-transform">
                    ...
                    <Badge className="bg-[#D4A017]/10 text-[#D4A017] border-none uppercase font-black text-[9px] tracking-widest px-4 py-1">
                      Capital / Parcelle
                    </Badge>
                  </div>
          ...
          {step === 3 && (
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-emerald-500 font-black text-sm uppercase tracking-[0.4em]">
                  SYNC IA: 99.8% OPTIMAL
                </p>
              </div>
    ...
    <Card className="border-none bg-white dark:bg-[#0a1f18] shadow-3xl rounded-[3rem] overflow-hidden group border border-slate-100 dark:border-white/5">
      <CardHeader className="p-10 border-b border-slate-50 dark:border-white/5 bg-slate-50/30 dark:bg-white/1">
        <div className="flex justify-between items-center">
          <CardTitle className="text-2xl font-black flex items-center gap-4 tracking-tighter uppercase text-[#1B4D3E] dark:text-white">
            <BarChart3 className="h-7 w-7 text-[#D4A017]" /> SIMULATEUR{' '}
            <span className="text-[#D4A017]">DYNAMIC</span>
          </CardTitle>
      ...
      <CardContent className="p-10 space-y-12">
        <div className="space-y-8">
          <div className="flex justify-between items-end">
            <div className="space-y-1">
              <Label className="uppercase text-[11px] font-black text-slate-400 tracking-[0.2em] ml-1">
                STOCK DISPONIBLE
              </Label>
              <p className="text-4xl font-black text-[#1B4D3E] dark:text-white tracking-tighter">
                {qty} <span className="text-lg text-slate-300">T</span>
              </p>
            </div>
          </div>
          <div className="relative py-4">
            ...
            <div className="flex justify-between mt-4">
              {[0, 25, 50, 75, 100].map((v) => (
                <span key={v} className="text-[10px] font-black text-slate-300">
                  {v}
                </span>
              ))}
            </div>
        ...
        <div className="space-y-8">
          <div className="flex justify-between items-end">
            <div className="space-y-1">
              ...
              <p className="text-4xl font-black text-[#D4A017] tracking-tighter">
                {price.toLocaleString()} <span className="text-lg text-slate-300">$</span>
              </p>
            </div>
          </div>
          <div className="relative py-4">
        ...
        <Card className="bg-[#1B4D3E] border-none rounded-[2.5rem] p-10 relative overflow-hidden group/revy shadow-2xl">
          ...
          <div className="relative z-10 space-y-4">
            <p className="text-[10px] font-black text-white/50 uppercase tracking-[0.4em] mb-1">
              REVENU BRUT CALCULÉ
            </p>
            ...
            <div className="flex items-center gap-3 pt-6">
              ...
              <Button
                variant="outline"
                className="border-white/20 text-white hover:bg-white/10 h-14 w-14 rounded-2xl shadow-xl"
              >
        ...
        <div className="absolute bottom-16 left-16 space-y-8 max-w-2xl">
          ...
          >
            ...
            <span className="text-[10px] font-black text-white uppercase tracking-[0.4em]">
              Système de Décision Autonome v4.2
            </span>
          </motion.div>
          ...
          <div className="space-y-4">
            ...
            >
              L'<span className="text-[#D4A017]">INTELLIGENCE</span>
              <br />
              AU CŒUR DU CHAMP
            </motion.h1>
            <motion.p
            ...
            >
              Déployez la puissance de l'IA générative et de l'analyse spectrale pour transformer
              vos données en récoltes records.
            </motion.p>
          </div>
          ...
          <div className="grid gap-12 md:grid-cols-2">
            ...
            <Card className="border-none bg-gradient-to-br from-[#1B4D3E] to-[#0a1f18] text-white shadow-3xl rounded-[3rem] p-12 flex flex-col justify-between group overflow-hidden relative">
              ...
              <div className="relative z-10 space-y-8">
                ...
                <div className="space-y-4">
                  <h3 className="text-4xl font-black tracking-tighter leading-tight uppercase">
                    PILOT AUTOMATISÉ
                  </h3>
                  <p className="text-white/60 font-bold text-lg leading-relaxed">
                    Activez le mode Smart-Pilot pour synchroniser vos systèmes d'irrigation et de
                    fertilisation avec les prévisions IA.
                  </p>
                </div>
              </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-10 border-t border-slate-100 dark:border-white/5">
        {[
          ...
          <div key={i} className="flex flex-col items-center text-center space-y-3">
            ...
            <p className="text-2xl font-black text-[#1B4D3E] dark:text-white uppercase">
              {stat.val}
            </p>
          </div>
        ))}
