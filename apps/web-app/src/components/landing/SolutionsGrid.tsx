...
const challenges = [
  ...
  },
  {
    ...
    description: "Utilisez l'intelligence agronomique pour prédire et maximiser la qualité de vos récoltes.",
    image: "/images/solutions/yield.png",
    link: "/solutions/yield"
  },
  {
    title: "Traçabilité & Conformité",
    description: "Assurez la transparence du champ à la table et répondez aux normes internationales (EUDR).",
    image: "/images/solutions/traceability.png",
    link: "/solutions/traceability"
  },
  {
    title: "Résilience Climatique",
    description: "Anticipez les risques météorologiques grâce à des modèles prédictifs haute résolution.",
    image: "/images/solutions/climate.png",
    link: "/solutions/climate"
  },
  {
    title: "Accès au Financement",
    description: "Simplifiez l'accès au crédit et à l'assurance grâce au scoring basé sur les données réelles.",
      ...
      <div className="container px-6 mx-auto">
        <div className="mb-20 text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-slate-500 font-medium leading-relaxed">
            Une suite complète d'outils interconnectés pour transformer vos défis quotidiens en opportunités de croissance durable.
          </p>
        </div>
