      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 text-sm">
            Gestion des risques, scoring ESG et audits de conformité.
          </p>
        </div>
          ...
          <div className="flex gap-2">
            <div className="relative">
              ...
              <Input
                ...
                className="h-8 w-48 pl-8 bg-slate-950 border-slate-700 text-xs"
              />
            </div>
            <Button
              variant="outline"
              size="sm"
              className="h-8 border-slate-700 bg-slate-900 text-slate-400"
            >
          ...
          <Table>
            <TableHeader className="bg-slate-950 sticky top-0">
              <TableRow className="border-slate-800 hover:bg-transparent">
                <TableHead className="text-slate-500 text-xs uppercase font-bold w-[250px]">
                  Fournisseur
                </TableHead>
              ...
              {SUPPLIERS.map((supplier) => (
                ...
                >
                  ...
                  <TableCell>
                    ...
                    {supplier.risk === 'HIGH' && (
                      <Badge className="bg-red-500/10 text-red-500 border-none hover:bg-red-500/20">
                        HIGH
                      </Badge>
                    )}
                  </TableCell>
                  ...
                  <TableCell>
                    <div className="flex gap-1">
                      {supplier.certifications.map((c) => (
                        <div
                          key={c}
                          className="h-5 px-1.5 rounded flex items-center bg-slate-800 border border-slate-700 text-[9px] font-bold text-slate-300"
                        >
                          {c}
                        </div>
                      ))}
