...
export function FreightMarketplace() {
  ...
  const filteredOffers = offers.filter(offer => {
     const matchesSearch = offer.origin.toLowerCase().includes(searchTerm.toLowerCase()) || 
    ...
    <div className="space-y-8 animate-in fade-in duration-700">
       <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
             ...
             <p className="text-slate-500 font-bold uppercase text-[10px] tracking-[0.4em]">Opportunités Temps Réel & Enchères</p>
          </div>
       ...
       <div className="grid gap-4">
                      ...
                      <div className="p-6 flex flex-col lg:flex-row gap-6 items-center">
                         ...
                         <div className="flex-1 space-y-4 w-full">
                            <div className="flex items-center justify-between">
                               <Badge variant="outline" className="text-[10px] uppercase font-black tracking-widest text-slate-500 border-slate-800">
                                  {offer.id}
                               </Badge>
                         ...
                         <div className="lg:border-l border-white/5 lg:pl-8 flex flex-col gap-4 min-w-[200px] w-full lg:w-auto">
                            <div className="text-right lg:text-left">
                               ...
                               <p className="text-3xl font-black text-emerald-400">{offer.price.toLocaleString()} FCFA</p>
                            </div>
                            ...
                            <div className="flex flex-col gap-2">
                               ...
                               >
                                  {processingId === offer.id ? "Validation Smart Contract..." : "Réserver (Instant)"}
                               </Button>
                               <Button 
                                 variant="outline" 
          ...
          {filteredOffers.length === 0 && (
             <div className="text-center py-20 opacity-50">
                <p className="text-xl font-bold text-slate-500">Aucune offre ne correspond à vos critères.</p>
             </div>
          )}
       </div>
    </div>
