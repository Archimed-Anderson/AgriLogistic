...
services:
  admin-service:
    build: ../services/identity/admin-service
    ...
    volumes:
      - ../services/identity/admin-service:/app
      - ../services/identity/auth-service/keys:/keys:ro
    depends_on:
      - admin-db
    networks:
      - kong-net
...
1. Créer la structure du projet services/identity/admin-service
