            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-6">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="aspect-square rounded-3xl bg-slate-50 border border-slate-100 flex items-center justify-center opacity-40 hover:opacity-100 transition-opacity cursor-pointer"
                  >
            ...
            <div className="flex flex-col h-full">
              <div className="mb-8">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div className="flex items-center gap-1 text-amber-500 bg-amber-50/50 px-3 py-1.5 rounded-full border border-amber-100">
                    ...
                    <span className="text-[10px] text-muted-foreground/60 ml-1 font-bold">
                      (128 avis)
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-auto space-y-6">
                ...
                <p className="text-center text-xs font-bold text-muted-foreground px-4">
                  Paiement sécurisé via AgriLogistic Pay. Stock disponible :{' '}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-12 pt-12 border-t border-slate-200/60">
                <p className="text-muted-foreground font-medium text-center">
                  Ce produit est récolté localement et traité dans le respect des normes d'hygiène
                  les plus strictes. Traçabilité blockchain disponible via AgriLogistic Trace.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {relatedProducts.map((p) => (
                <div key={p.id} className="group cursor-pointer">
                  ...
                  <h3 className="font-black text-primary text-lg group-hover:text-orange-500 transition-colors">
                    {p.name}
                  </h3>
