...
export const farmPlots: FarmPlot[] = [
  {
    ...
    coordinates: [5.3600, -4.0083], // Zone Abidjan
    status: "optimal",
    alerts: 0,
  },
  {
    ...
    moisture: 60, // %
    image: "https://images.unsplash.com/photo-1524334228333-0f6db392f8a1?q=80&w=800&auto=format&fit=crop",
  ...
  },
  {
    ...
    moisture: 80, // %
    image: "https://images.unsplash.com/photo-1549419149-c12c3f875e54?q=80&w=800&auto=format&fit=crop",
...
export const farmArticles: FarmArticle[] = [
  {
    ...
    excerpt: "Dossier Complet : Comment les capteurs IoT et les drones transforment les petites exploitations familiales en Côte d'Ivoire.",
    category: "Innovation",
    readTime: "8 min",
    imageUrl: "https://images.unsplash.com/photo-1586771107445-d3ca888129ff?q=80&w=800&auto=format&fit=crop", // Drone
    author: "Tech Afrique",
    date: "29 Jan 2026",
  ...
  },
  {
    ...
    excerpt: "Tutoriel étape par étape pour réduire vos coûts énergétiques et optimiser l'utilisation de l'eau pendant la saison sèche.",
    category: "Tutoriel",
    readTime: "12 min",
  ...
  },
  {
    ...
    excerpt: "Analyse des prix bord champ et impact des nouvelles régulations européennes sur la traçabilité.",
    category: "Marché",
    readTime: "5 min",
    imageUrl: "https://images.unsplash.com/photo-1615811361269-669f444d99ad?q=80&w=800&auto=format&fit=crop", // Cocoa
  ...
  },
  {
    ...
    excerpt: "Une alternative écologique et économique pour protéger vos cultures maraîchères contre les ravageurs.",
    category: "Bio",
    readTime: "6 min",
    imageUrl: "https://images.unsplash.com/photo-1530836369250-ef72a3f5cda8?q=80&w=800&auto=format&fit=crop", // Plants/Neem
    author: "BioIvoire",
    date: "20 Jan 2026",
    sourceUrl: "#",
  },
  {
    ...
    excerpt: "Les nouvelles solutions de micro-crédit digital disponibles pour les agriculteurs ivoiriens en 2026.",
    category: "Marché",
    readTime: "7 min",
    imageUrl: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=800&auto=format&fit=crop", // Finance/Money
    author: "FinAgri",
    date: "18 Jan 2026",
    sourceUrl: "#",
  },
  {
    ...
    excerpt: "Techniques anciennes et modernes pour préserver la santé de vos sols sans engrais chimiques excessifs.",
    category: "Bio",
    readTime: "9 min",
    imageUrl: "https://images.unsplash.com/photo-1500651230702-0e2d8a49d4ad?q=80&w=800&auto=format&fit=crop", // Aerial field
    author: "EcoTerre",
    date: "15 Jan 2026",
    sourceUrl: "#",
  },
  {
    ...
    category: "Innovation",
    readTime: "6 min",
    imageUrl: "https://images.unsplash.com/photo-1628135899933-7255aa0df67f?q=80&w=800&auto=format&fit=crop", // Robot/Tech
    author: "FuturAgri",
    date: "12 Jan 2026",
    sourceUrl: "#",
  },
  {
    ...
    category: "Tutoriel",
    readTime: "15 min",
    imageUrl: "https://images.unsplash.com/photo-1584450150058-2082faecbd24?q=80&w=800&auto=format&fit=crop", // Compost/Soil
    author: "AgriTuto",
    date: "10 Jan 2026",
    sourceUrl: "#",
  }
...
export const farmVideos: FarmVideo[] = [
  {
    ...
    thumbnail: "https://images.unsplash.com/photo-1594771804886-715c0e2136e6?q=80&w=800&auto=format&fit=crop",
