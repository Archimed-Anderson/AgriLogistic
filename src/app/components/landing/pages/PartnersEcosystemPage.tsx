...
export function PartnersEcosystemPage({ onNavigate }: { onNavigate: (route: string) => void }) {
  ...
  const techPartners = [
    { name: 'IoT Valley', icon: Radio, desc: 'Capteurs connectés & Réseaux LPWAN' },
    {
      ...
      icon: Database,
      desc: 'Traçabilité inviolable & Smart Contracts',
    },
      ...
      <section className="relative bg-slate-900 py-24 sm:py-32 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-300">
            Nous ne construisons pas le futur de l'agrologistique seuls. Découvrez le réseau
            d'excellence qui propulse AgroLogistic.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-slate-600">
              Ils assurent le mouvement physique de vos marchandises avec fiabilité.
            </p>
          </div>
          <div className="grid grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
            {logisticsPartners.map((partner) => (
              <div
                key={partner.name}
                className="flex flex-col items-center bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 border border-slate-100 group"
              >
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-300">
              Vous proposez des services logistiques, technologiques ou financiers innovants ?
              Rejoignez l'écosystème AgroLogistic.
            </p>
