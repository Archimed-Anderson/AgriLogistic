...
const profiles = [
  {
    ...
    description: "Maximisez la valeur de votre récolte avec des outils de prévision et un accès direct aux acheteurs industriels.",
    benefits: [
  ...
  },
  {
    ...
    bgAccent: "bg-blue-50",
    description: "Optimisez vos flottes et réduisez vos trajets à vide grâce à notre algorithme de matching intelligent.",
    benefits: [
  ...
  },
  {
    ...
    description: "Accédez à des produits frais et tracés directement depuis la source, avec une garantie de qualité totale.",
    benefits: [
    ...
    <section className="py-32 relative overflow-hidden bg-white">
      ...
      <div className="container px-6 mx-auto relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20 animate-fade-in">
          <h2 className="text-sm font-bold text-primary uppercase tracking-[0.2em] mb-4">Écosystème Vertueux</h2>
          ...
          <p className="text-slate-500 text-lg md:text-xl font-medium leading-relaxed">
            AgriLogistic unifie la chaîne de valeur en offrant des outils technologiques de pointe adaptés aux besoins spécifiques de chaque métier.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center p-2 bg-slate-50 rounded-4xl max-w-2xl mx-auto mb-20 border border-slate-100 shadow-sm">
          {profiles.map((profile) => (
            ...
            >
              <profile.icon className={cn("h-5 w-5", activeTab === profile.id ? "text-primary" : "text-current")} />
              {profile.title}
            </button>
          ))}
        </div>
          ...
          <div className="bg-white rounded-[3rem] p-8 md:p-16 border border-slate-50 shadow-2xl shadow-slate-200/50">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-10 order-2 lg:order-1">
                <div className={cn("inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest", activeProfile.bgAccent, activeProfile.accent)}>
                ...
                <div className="pt-6 flex flex-col sm:flex-row gap-4">
                  <Button size="lg" className="h-16 px-10 rounded-2xl bg-primary text-white font-black hover:scale-105 transition-all shadow-xl shadow-primary/20">
                    {activeProfile.cta}
              ...
              <div className="relative order-1 lg:order-2">
                ...
                <div className="absolute -bottom-8 -left-8 p-8 glass-dark rounded-4xl shadow-2xl animate-float backdrop-blur-2xl bg-white/90 border-slate-100">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <span className="text-xs font-black text-slate-400 uppercase tracking-widest block mb-1">Impact Mesuré</span>
                      <span className="text-3xl font-black text-primary">{activeProfile.impact}</span>
                    </div>
                  </div>
                </div>

                {/* Subtle Glow */}
                <div className={cn("absolute -top-10 -right-10 w-40 h-40 rounded-full blur-[80px] opacity-20", activeProfile.bgAccent)} />
              </div>
