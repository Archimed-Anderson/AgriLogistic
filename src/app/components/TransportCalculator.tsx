  ...
  const calculateTransport = async () => {
    ...
    setTimeout(() => {
      ...
      const merchandiseMultiplier =
        merchandiseType === 'perishable'
          ? 1.3
          : merchandiseType === 'bulk'
          ? 1.4
          : merchandiseType === 'fragile'
          ? 1.2
          : 1;

      const urgencyMultiplier = urgency === 'express' ? 1.5 : urgency === 'urgent' ? 2 : 1;
