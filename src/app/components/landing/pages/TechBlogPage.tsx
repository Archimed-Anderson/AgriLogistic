...
export function TechBlogPage({ onNavigate }: { onNavigate: (route: string) => void }) {
  ...
  const featuredArticle = {
    ...
    excerpt:
      'Découvrez la nouvelle version majeure de notre plateforme. Traçabilité Blockchain native, optimisation IA temps réel et interface repensée pour les coopératives.',
    author: {
      name: 'Thomas Tech',
    ...
    readTime: 5,
    image_url:
      'https://images.unsplash.com/photo-1586771107445-d3ca888129ff?ixlib=rb-4.0.3&auto=format&fit=crop&w=2072&q=80',
  };
  ...
  const articles = [
    {
      ...
      excerpt:
        "Étude de cas sur l'intégration de capteurs LoRaWAN chez GreenLog, réduisant les pertes de marchandises de 40%.",
      author: {
        name: 'Sarah Green',
        avatar_url:
      ...
      readTime: 8,
      image_url:
        'https://images.unsplash.com/photo-1555664424-778a69022365?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80',
    },
    {
      id: '2',
      title: 'Blockchain et Agriculture : Au-delà du Buzz',
      excerpt:
        'Comprendre concrètement comment AgroLogistic utilise la blockchain pour certifier chaque transaction de votre exploitation.',
      author: {
        name: 'Alex Chain',
        avatar_url:
      ...
      readTime: 12,
      image_url:
        'https://images.unsplash.com/photo-1639322537228-ad71c4295843?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80',
    },
    {
      id: '3',
      title: 'Témoignage : La Coopérative du Sud',
      excerpt:
        "Retour d'expérience sur l'implémentation de nos outils de gestion de tournées et l'impact sur la rentabilité.",
      author: {
        name: 'Marie Route',
        avatar_url:
      ...
      readTime: 15,
      image_url:
        'https://images.unsplash.com/photo-1595839019779-11ba1ef5dcef?ixlib=rb-4.0.3&auto=format&fit=crop&w=2074&q=80',
    },
    {
      id: '4',
      title: 'Réduire son empreinte carbone en logistique',
      excerpt:
        "Nos meilleures pratiques pour configurer l'algorithme de routing et économiser jusqu'à 20% de carburant.",
      author: {
        name: 'Jean Durable',
        avatar_url:
      ...
      readTime: 6,
      image_url:
        'https://images.unsplash.com/photo-1469122312224-c5846569feb1?ixlib=rb-4.0.3&auto=format&fit=crop&w=2089&q=80',
    },
  ];

  const filteredArticles =
    selectedFilter === 'Tous' ? articles : articles.filter((a) => a.category === selectedFilter);
      ...
      <section className="bg-slate-50 border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 py-20 lg:py-28 text-center">
          ...
          <p className="text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed">
            Explorez nos dernières actualités, découvrez nos expertises techniques et inspirez-vous
            des réussites de nos partenaires.
          </p>
        </div>
      </section>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex flex-col justify-center space-y-6">
                ...
                <p className="text-lg text-slate-600 leading-relaxed">{featuredArticle.excerpt}</p>
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-slate-400 mb-8">
                Recevez nos dernières analyses, mises à jour produits et invitations à nos
                webinaires directement dans votre boîte mail.
              </p>
              <div className="flex items-start gap-4 text-slate-300 text-sm">
                <div className="flex items-center gap-2">
                  <CheckBadge /> Pas de spam
                </div>
                <div className="flex items-center gap-2">
                  <CheckBadge /> Désabonnement facile
                </div>
              </div>
            </div>
            <div className="bg-white/5 p-6 rounded-2xl border border-white/10 backdrop-blur-sm">
              <form className="flex flex-col gap-4">
                ...
                <button
                  type="button"
                  className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-emerald-600 hover:bg-emerald-700 md:py-3 md:text-lg md:px-10 transition-colors shadow-lg shadow-emerald-900/20"
                >
