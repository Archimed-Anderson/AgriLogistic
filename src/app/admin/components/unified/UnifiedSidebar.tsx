       ...
       <div className="space-y-1">
          <button 
            ...
            className={cn(
               ...
               isActive ? "text-primary bg-primary/10" : "text-muted-foreground hover:bg-foreground/5 hover:text-foreground"
            )}
          >
             <div className="flex items-center gap-3">
    ...
    >
      ...
      {item.badge && (
        <span className={cn(
           ...
           item.badge === 'Live' ? "bg-emerald-500/10 text-emerald-500" : 
           item.badge === 'Prioritaire' ? "bg-amber-500/10 text-amber-500" :
