        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-black text-white uppercase tracking-[0.2em]">Mode Impersonation :</span>
              <div className="flex items-center gap-2 bg-black/20 px-3 py-1 rounded-full border border-white/10">
                 ...
                 <span className="text-[9px] font-mono text-white/50 uppercase">[{impersonatedUser?.role}]</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            <p className="hidden md:block text-[10px] font-black text-white/70 uppercase tracking-widest text-right">
              Toutes vos actions sont auditées comme <br/> <span className="text-white">IMPERSONATE_SESSION</span>
            </p>
            <Button 
