      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 text-sm">
            Gestion des contrats Blockchain et Escrow Agreements.
          </p>
        </div>
        <Button
      ...
      {showBuilder ? (
        <div className="flex-1 min-h-0 relative">
          <Button
            ...
            className="absolute -top-10 right-40 text-slate-400"
          >
            Retour Liste
          </Button>
        ...
        <div className="flex-1 min-h-0 space-y-6">
          ...
          <div className="flex items-center gap-4">
            <div className="relative flex-1 max-w-sm">
              ...
              <Input
                placeholder="Rechercher par hash, ID, ou contrepartie..."
                className="pl-9 bg-slate-900 border-slate-800 text-slate-300"
              />
            </div>
            <Button
              variant="outline"
              className="border-slate-800 bg-slate-900 text-slate-400 gap-2"
            >
