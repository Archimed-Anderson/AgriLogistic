      ...
      <div className="p-6 max-w-7xl mx-auto w-full">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          {events.map((event) => (
            <div
              key={event.id}
              className="grid grid-cols-[2fr_1fr_1fr_1fr_100px] gap-4 p-4 border-b border-slate-100 items-center hover:bg-slate-50 transition-colors"
            >
              <div>
              ...
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="h-6 w-6 rounded-full bg-slate-200 border-2 border-white"
                    />
                  ))}
                </div>
        ...
        <div className="mt-6 bg-emerald-50 border border-emerald-100 rounded-xl p-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-emerald-700/80 text-sm">
              Activez la vue carte pour voir la répartition géographique de vos événements.
            </p>
          </div>
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: Salon de l'Agriculture"
                />
              </div>
