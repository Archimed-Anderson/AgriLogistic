              ...
              <div className="space-y-8">
                <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-xl">
                  ...
                  <span className="text-[11px] font-black uppercase tracking-[0.25em] text-emerald-400">
                    Standard Excellence AgTech
                  </span>
                </div>

                <h1 className="text-5xl lg:text-7xl xl:text-8xl font-extrabold tracking-tighter text-white leading-[0.95]">
                  Voir{' '}
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-accent">
                    AgriLogistic
                  </span>{' '}
                  <br />
                  en action.
                ...
                <p className="text-xl lg:text-2xl text-emerald-50/70 font-medium leading-relaxed max-w-xl">
                  L'écosystème IA le plus avancé pour les leaders de la chaîne de valeur agricole en
                  Afrique.
                </p>
              </div>
                ...
                {[
                  ...
                  <div key={i} className="flex gap-6 group items-start">
                    ...
                    <div className="space-y-2">
                      <p className="text-xl font-black text-white group-hover:text-accent transition-colors tracking-tight">
                        {item.text}
                      </p>
              ...
              <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row items-center gap-8 opacity-60">
                <div className="flex -space-x-4">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="h-12 w-12 rounded-full border-4 border-[#0A2619] bg-slate-800 flex items-center justify-center"
                    >
