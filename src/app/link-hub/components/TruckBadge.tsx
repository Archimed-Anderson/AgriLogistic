  ...
  return (
    <motion.div
      ...
      className={`truck-badge-premium p-4 rounded-xl cursor-pointer transition-all border ${
        isSelected
          ? 'border-logistics-neon bg-logistics-neon/5 ring-1 ring-logistics-neon/30'
    ...
    >
        ...
        <div className="flex items-center gap-2">
          <div
            className={`w-2 h-2 rounded-full ${
              truck.status === 'Available' ? 'bg-agri-neon animate-pulse' : 'bg-gray-600'
            }`}
          ></div>
      ...
      <div className="mb-3">
        ...
        <p className="text-[11px] text-gray-500">
          {truck.truckType} • {truck.capacity}t max
        </p>
      </div>
