        ...
        <div className="relative z-10 flex h-full w-full flex-col justify-between p-12 text-white">
          ...
          <div className="max-w-xl space-y-6 animate-in fade-in slide-in-from-left-8 duration-700">
            ...
            <p className="text-lg text-emerald-50/80 leading-relaxed">
              Créez votre compte et commencez à transformer votre exploitation agricole avec des
              outils modernes et intelligents.
            </p>
          </div>
          ...
          <div className="space-y-2 text-center lg:text-left">
            ...
            <div className="space-y-3">
              <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
                {step === 1 ? 'Choisissez votre' : 'Créez votre'}{' '}
                <span className="text-primary italic">
                  {step === 1 ? "type d'activité" : 'compte sécurisé'}
                </span>
              </h1>
              ...
              {step === 1 ? (
                <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                  <CardHeader>
                    ...
                    <CardDescription>Sélectionnez votre profil</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-start gap-3">
                              <div
                                className={`p-2.5 rounded-xl bg-gradient-to-br transition-transform group-hover/btn:scale-110 ${type.color} text-white shadow-lg`}
                              >
                    ...
                    <div className="pt-4">
                      <Button className="w-full h-11 font-bold group" onClick={() => setStep(2)}>
                        Continuer
                ...
                <div className="animate-in fade-in slide-in-from-left-4 duration-500">
                  <CardHeader className="flex flex-row items-center gap-4 space-y-0">
                    ...
                    <div>
                      ...
                      <CardDescription>
                        Compte {accountTypes.find((t) => t.role === selectedRole)?.label}
                      </CardDescription>
                    </div>
                  </CardHeader>
                  <CardContent>
