          ...
          <CardHeader className="flex flex-row items-center justify-between pb-2 border-b border-slate-800">
            <div>
              ...
              <CardDescription className="text-xs text-slate-400">
                Historique 6M + Prédiction IA 3M
              </CardDescription>
            </div>
            <div className="flex gap-2">
              <Badge variant="outline" className="border-blue-500/20 text-blue-400">
                Confiance IA: {data.meta.confidence * 100}%
              </Badge>
            </div>
          </CardHeader>
        ...
        <Card className="bg-gradient-to-br from-indigo-900 to-slate-900 border-indigo-500/30">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-indigo-100/80 leading-relaxed">
              Le cours des Poivrons est en hausse (+12%). Remplacez par des{' '}
              <span className="text-white font-bold underline decoration-indigo-400 decoration-2">
        ...
        <Card className="flex-1 bg-slate-900 border-slate-800">
          ...
          <div className="relative flex-1 min-h-[150px] m-4 rounded bg-slate-800/50 overflow-hidden">
            ...
            <div className="absolute inset-0 grid grid-cols-2 grid-rows-2 gap-0.5 opacity-60">
              <div className="bg-red-500/40 flex items-center justify-center text-[10px] font-bold text-red-200">
                Nord (Tension)
              </div>
              <div className="bg-emerald-500/40 flex items-center justify-center text-[10px] font-bold text-emerald-200">
                Sud (Abondance)
              </div>
              <div className="bg-amber-500/40 flex items-center justify-center text-[10px] font-bold text-amber-200">
                Est (Stable)
              </div>
              <div className="bg-emerald-500/40 flex items-center justify-center text-[10px] font-bold text-emerald-200">
                Ouest (Abondance)
      ...
      <div className="col-span-12">
        <Card className="bg-slate-900 border-slate-800">
          <div className="flex items-center gap-4 p-4 overflow-x-auto">
            <Badge
              variant="outline"
              className="shrink-0 border-red-500/30 bg-red-500/10 text-red-500 gap-2 px-3 py-1"
            >
            ...
            <Badge
              variant="outline"
              className="shrink-0 border-blue-500/30 bg-blue-500/10 text-blue-500 gap-2 px-3 py-1"
            >
              <Layers size={12} />
