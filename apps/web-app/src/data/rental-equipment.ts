...
export const rentalEquipmentData: RentalEquipment[] = [
  // ==================== TRACTEURS & ENGINS LOURDS (8) ====================
  {
    ...
    image: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=1200&h=800&fit=crop&q=80&auto=format', // Tractor field
    description: 'Tracteur polyvalent de 120 CV, idéal pour labour, semis et travaux de manutention. État impeccable, révision complète effectuée.',
    specs: {
      power: '120 CV',
      weight: '4200 kg',
      fuelType: 'Diesel',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1625246394753-b1e36fa03763?w=1200&h=800&fit=crop&q=80&auto=format', // Combine harvester
    description: 'Moissonneuse-batteuse haute performance pour céréales. Capacité de trémie 10 500 L. Disponible pour saison de récolte.',
    specs: {
      power: '435 CV',
      weight: '15800 kg',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=1200&h=800&fit=crop&q=80&auto=format', // Wheel loader
    description: 'Chargeur compact pour manutention et terrassement. Godet de 2,3 m³. Parfait pour chantiers agricoles et construction.',
    specs: {
      power: '152 CV',
      weight: '11500 kg',
  ...
  },
  {
    ...
    deposit: 1500,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=1200&h=800&fit=crop&q=80&auto=format', // Excavator
    description: 'Mini-pelle 8 tonnes pour travaux de terrassement, drainage et fondations. Très maniable, idéale pour espaces restreints.',
    specs: {
      power: '55 CV',
      weight: '8000 kg',
  ...
  },
  {
    ...
    price: 65000,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?w=1200&h=800&fit=crop&q=80&auto=format', // Tractor aerial
    description: 'Tracteur agricole 95 CV avec cabine climatisée. Excellent état, 1200 heures au compteur. Idéal exploitation moyenne.',
    specs: {
      power: '95 CV',
      weight: '3800 kg',
      fuelType: 'Diesel',
  ...
  },
  {
    ...
    deposit: 2500,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1572981889563-c82f1f6d5dd0?w=1200&h=800&fit=crop&q=80&auto=format', // Construction equipment
    description: 'Équipement 2-en-1: chargeur frontal et pelle arrière. Polyvalence maximale pour tout type de chantier.',
    specs: {
      power: '109 CV',
      weight: '8500 kg',
  ...
  },
  {
    ...
    deposit: 2000,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1581092162384-8987c1d64718?w=1200&h=800&fit=crop&q=80&auto=format', // Telehandler
    description: 'Chariot télescopique agricole. Hauteur de levage 6m, capacité 2500 kg. Parfait pour stockage et manutention.',
    specs: {
      power: '75 CV',
      weight: '5200 kg',
  ...
  },
  {
    ...
    deposit: 5000,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1581093450021-4a7360e9a6b5?w=1200&h=800&fit=crop&q=80&auto=format', // Bulldozer
    description: 'Bulldozer chenillé pour gros travaux de terrassement et nivellement. Lame droite 3,4m. Location minimum 1 semaine.',
    specs: {
      power: '105 CV',
      weight: '11200 kg',
      capacity: '3.4m lame',
  ...
  // ==================== MACHINES DE TRAITEMENT (6) ====================
  {
    ...
    price: 4500,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?w=1200&h=800&fit=crop&q=80&auto=format', // Farming equipment
    description: 'Couveuse professionnelle automatique 190 œufs. Retournement automatique, contrôle température et humidité digital.',
    specs: {
      capacity: '190 œufs',
      power: '150 W',
  ...
  },
  {
    ...
    deposit: 1000,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=1200&h=800&fit=crop&q=80&auto=format', // Grain processing
    description: 'Nettoyeuse-trieuse pour céréales et légumineuses. Débit 5 tonnes/heure. Séparation par densité et calibre.',
    specs: {
      capacity: '5000 kg/h',
      power: '7.5 kW',
  ...
  },
  {
    ...
    price: 8900,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1536304929831-ee1ca9d10249?w=1200&h=800&fit=crop&q=80&auto=format', // Rice processing
    description: 'Décortiqueuse professionnelle pour riz paddy. Rendement 500-800 kg/h avec taux de brisure minimal.',
    specs: {
  ...
  },
  {
    ...
    deposit: 800,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1505798577917-a65157d3320a?w=1200&h=800&fit=crop&q=80&auto=format', // Oil press machinery
    description: 'Extracteur d\'huile multi-graines (arachide, tournesol, soja). Capacité 200 kg/h. Système de filtrage intégré.',
    specs: {
      capacity: '200 kg/h',
      power: '11 kW',
      weight: '900 kg',
  ...
  },
  {
    ...
    deposit: 1500,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=1200&h=800&fit=crop&q=80&auto=format', // Drying equipment
    description: 'Séchoir mobile à grains. Capacité 18 tonnes. Brûleur gaz propane. Ventilation ajustable.',
    specs: {
      capacity: '18000 kg',
  ...
  },
  {
    ...
    price: 22000,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1581093588401-fbb62a02f120?w=1200&h=800&fit=crop&q=80&auto=format', // Packaging machine
    description: 'Machine d\'ensachage automatique pour sacs 5-50 kg. Pesée électronique, cadence 12 sacs/minute.',
    specs: {
  ...
  // ==================== MAINTENANCE & NETTOYAGE (5) ====================
  {
    ...
    deposit: 500,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=1200&h=800&fit=crop&q=80&auto=format', // Farming field
    description: 'Désherbeur thermique à gaz pour désherbage écologique grande surface. 4 brûleurs orientables.',
    specs: {
  ...
  },
  {
    ...
    deposit: 1000,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=1200&h=800&fit=crop&q=80&auto=format', // Wood chipper
    description: 'Broyeur forestier remorquable. Diamètre max 150mm. Goulotte orientable 360°. Idéal élagage et entretien.',
    specs: {
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=1200&h=800&fit=crop&q=80&auto=format', // Sprayer
    description: 'Pulvérisateur traîné 2000L, rampe 18m. Régulation électronique, GPS compatible. Pour grandes cultures.',
    specs: {
      capacity: '2000 L',
      power: 'Rampe 18m',
      weight: '1800 kg',
  ...
  },
  {
    ...
    deposit: 300,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1581093458791-9d42e31e9770?w=1200&h=800&fit=crop&q=80&auto=format', // Pressure washer
    description: 'Nettoyeur haute pression professionnel eau froide. 250 bars, 1000 L/h. Pour lavage matériel agricole.',
    specs: {
  ...
  },
  {
    ...
    deposit: 800,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1581092795360-fd1ca04f0952?w=1200&h=800&fit=crop&q=80&auto=format', // Sweeper
    description: 'Balayeuse compacte pour cours, entrepôts et allées. Largeur balayage 1,1m, trémie 60L.',
    specs: {
  ...
  // ==================== MATÉRIAUX DE CONSTRUCTION (6) ====================
  {
    ...
    price: 28000,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1589923188900-85dae523342b?w=1200&h=800&fit=crop&q=80&auto=format', // Brick making machine
    description: 'Machine de fabrication de briques et pavés semi-automatique. Production 3600-4000 briques/jour. Moules interchangeables.',
    specs: {
  ...
  },
  {
    ...
    deposit: 400,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1581093450021-4a7360e9a6b5?w=1200&h=800&fit=crop&q=80&auto=format', // Concrete mixer
    description: 'Bétonnière professionnelle 350L basculante. Moteur électrique triphasé. Châssis renforcé.',
    specs: {
      capacity: '350 L',
      power: '2.2 kW',
  ...
  },
  {
    ...
    deposit: 800,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1572981889563-c82f1f6d5dd0?w=1200&h=800&fit=crop&q=80&auto=format', // Air compressor
    description: 'Compresseur portable diesel 10 bars, débit 10,5 m³/min. Pour marteau-piqueur et outils pneumatiques.',
    specs: {
  ...
  },
  {
    ...
    deposit: 300,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=1200&h=800&fit=crop&q=80&auto=format', // Laser level
    description: 'Niveau laser rotatif auto-nivelant. Portée 800m diamètre. Précision ±1,5mm/30m. Coffret complet.',
    specs: {
  ...
  },
  {
    ...
    deposit: 600,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=1200&h=800&fit=crop&q=80&auto=format', // Scaffolding
    description: 'Échafaudage mobile aluminium hauteur de travail 6m. Montage rapide sans outils. Plancher 1,35 × 2,46m.',
    specs: {
  ...
  },
  {
    ...
    deposit: 900,
    availability: 'DISPONIBLE',
    image: 'https://images.unsplash.com/photo-1581093588401-fbb62a02f120?w=1200&h=800&fit=crop&q=80&auto=format', // Screed pump
    description: 'Pompe à chape liquide et mortier. Débit 40 L/min, hauteur de refoulement 50m. Pour sols et chapes.',
    specs: {
      capacity: '40 L/min',
      power: '4 kW',
...
export function getRentalStatistics() {
  ...
  const forRent = rentalEquipmentData.filter(eq => 
    eq.type === 'LOCATION' || eq.type === 'LOCATION_VENTE'
  ).length
  
  const forSale = rentalEquipmentData.filter(eq => 
    eq.type === 'VENTE' || eq.type === 'LOCATION_VENTE'
  ).length
  
  const avgRating = rentalEquipmentData
    .filter(eq => eq.rating)
    .reduce((sum, eq) => sum + (eq.rating || 0), 0) / 
...
export function filterByType(type: EquipmentType) {
  if (type === 'LOCATION') {
    return rentalEquipmentData.filter(eq => 
      eq.type === 'LOCATION' || eq.type === 'LOCATION_VENTE'
    )
  }
  if (type === 'VENTE') {
