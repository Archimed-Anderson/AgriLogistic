          ...
          {STEPS.map((step, index) => {
            ...
            return (
              ...
              >
                {/* Icon Dot */}
                <div
                  className={`absolute left-2.5 -translate-x-1/2 w-8 h-8 rounded-full border-2 flex items-center justify-center bg-slate-950 z-10 transition-colors ${
                    isActive
                      ? 'border-blue-500 text-blue-500 shadow-[0_0_15px_-3px_rgba(59,130,246,0.5)]'
                      : isCompleted
                ...
                <div
                  className={`p-4 rounded-xl border transition-all ${
                    isActive
                      ? 'bg-slate-900/80 border-blue-500/50 shadow-lg'
                ...
                >
                  ...
                  {isCompleted && (
                    <div className="flex items-center gap-1 text-[10px] text-emerald-500 font-bold uppercase">
                      <CheckCircle2 size={10} /> Validé Blockchain
                    </div>
                  )}
                  {isActive && (
                    <div className="flex items-center gap-1 text-[10px] text-blue-400 font-bold uppercase">
                      <div className="w-1.5 h-1.5 rounded-full bg-blue-400 animate-pulse" /> En
                      Cours
                    </div>
                  )}
                </div>
                  ...
                  <div className="mt-4 p-3 rounded bg-red-500/10 border border-red-500/20 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-red-300">
                        Pic de température détecté à 10:45 (6.2°C). Rétabli automatiquement.
                      </p>
                    </div>
                  </div>
                </div>
