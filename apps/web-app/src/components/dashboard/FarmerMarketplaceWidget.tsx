      ...
      <div className="p-8 space-y-6">
        ...
        <div className="flex items-end justify-between">
          <div className="space-y-1">
            ...
            <p className="text-3xl font-black text-[#D4A017] tracking-tighter">
              {product.price}{' '}
              <span className="text-xs text-[#D4A017]/40 uppercase tracking-widest">
                € / {product.unit}
              </span>
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2">
          <div className="p-12 space-y-8">
            <div className="space-y-2">
              <Badge className="bg-[#1B4D3E] text-white font-black text-[9px] tracking-widest px-4 py-1.5 rounded-full mb-4">
                AGRILINK v2.4 ENGINE
              </Badge>
              <h2 className="text-4xl font-black tracking-tighter uppercase leading-none text-[#1B4D3E] dark:text-white">
                Matching <span className="text-[#D4A017]">Logistique</span>
              </h2>
              <p className="text-slate-400 font-bold text-sm">
                Optimisation multisectorielle des flux de collecte.
              </p>
            </div>
              ...
              <div className="py-20 flex flex-col items-center justify-center space-y-6 text-center">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-slate-400 font-bold uppercase">
                    Analyse de 12 transporteurs à proximité
                  </p>
                </div>
              </div>
            ) : (
                ...
                <div className="bg-emerald-500/10 p-8 rounded-[2rem] border border-emerald-500/20 space-y-4">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-black uppercase text-emerald-900 dark:text-emerald-400 tracking-widest">
                          TRANSPORTEUR VERROUILLÉ
                        </p>
                  ...
                  <div className="grid grid-cols-2 gap-4 border-t border-emerald-200/30 pt-4">
                    <div className="space-y-1">
                      <p className="text-[8px] font-black text-emerald-900/40 uppercase">
                        DÉLAI ESTIMÉ
                      </p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="p-6 bg-slate-50 dark:bg-white/5 rounded-3xl space-y-1">
                    ...
                    <p className="text-xl font-black text-emerald-600">
                      -24% <span className="text-[10px] font-bold">Optimisé</span>
                    </p>
                  </div>
                  <div className="p-6 bg-slate-50 dark:bg-white/5 rounded-3xl space-y-1">
                    <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest">
            ...
            {!isOptimizing && (
              ...
              >
                ...
                <foreignObject x="60" y="80" width="100" height="40">
                  <div className="bg-white px-2 py-1 rounded-lg text-[8px] font-black uppercase text-black">
                    VOTRE FERME
                  </div>
                </foreignObject>
                <foreignObject x="250" y="520" width="100" height="40">
                  <div className="bg-[#D4A017] px-2 py-1 rounded-lg text-[8px] font-black uppercase text-white shadow-xl">
                    CENTRE COLLECTE
                  </div>
                </foreignObject>
              </svg>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-4xl font-black tracking-tighter uppercase leading-none">
                Canal <span className="text-[#D4A017]">Grossiste</span>
              </h2>
              <p className="text-slate-500 font-bold text-sm uppercase tracking-widest mt-1">
                Négociation de volumes industriels (20T+)
              </p>
            </div>
          </div>
        </div>
        ...
        <Card className="border-none bg-white dark:bg-[#0a1f18] shadow-3xl rounded-[3rem] p-10 border border-slate-100 dark:border-white/5 overflow-hidden relative">
          ...
          <CardContent className="p-0 space-y-10">
            <div className="space-y-6">
              <Label className="uppercase text-[11px] font-black text-slate-400 tracking-[0.3em] ml-2">
                QUANTITÉ SOUHAITÉE (TONNES)
              </Label>
              <div className="flex items-center gap-6">
                <div className="text-6xl font-black text-[#1B4D3E] dark:text-white tracking-widest">
                  {qty}
                </div>
                <input
                  type="range"
            ...
            <div className="space-y-6">
              <Label className="uppercase text-[11px] font-black text-slate-400 tracking-[0.3em] ml-2">
                PRIX CIBLE NÉGOCIÉ (€/T)
              </Label>
              <div className="flex items-center gap-6">
                <div className="text-6xl font-black text-[#D4A017] tracking-widest">
                  {targetPrice}
                </div>
                <input
                  type="range"
            ...
            <div className="bg-slate-50 dark:bg-white/5 rounded-3xl p-8 space-y-4">
              <div className="flex justify-between items-center text-xs font-black uppercase tracking-widest">
                ...
                <span className="text-xl font-black text-[#1B4D3E] dark:text-white">
                  {(qty * targetPrice).toLocaleString()} €
                </span>
              </div>
              <div className="flex justify-between items-center text-xs font-black uppercase tracking-widest">
        ...
        <Card className="border-none bg-[#050505] text-white shadow-3xl rounded-[3rem] p-10 overflow-hidden relative group">
          ...
          <CardHeader className="p-0 mb-10 relative">
            ...
            <p className="text-[10px] font-black uppercase text-white/30 tracking-[0.2em]">
              Flux haute-fréquence du Hub Régional
            </p>
          </CardHeader>
          <CardContent className="p-0 space-y-6 relative">
            {[
              {
                buyer: 'AgriCorp France',
                need: 'Blé Panifiable',
                qty: '200T',
                price: '242€',
                reliability: '98%',
              ...
              <div
                key={i}
                className="bg-white/5 p-6 rounded-3xl border border-white/5 hover:border-white/20 transition-all flex items-center justify-between group/offer"
              >
                <div className="space-y-1">
                  <p className="text-lg font-black tracking-tight">{offer.buyer}</p>
                  <p className="text-[10px] font-black text-white/30 uppercase tracking-widest">
                    {offer.need} // {offer.qty}
                  </p>
                </div>
                <div className="text-right space-y-2">
                  ...
                  <Button
                    variant="ghost"
                    className="h-8 px-4 border border-white/10 rounded-full text-[9px] font-black text-white group-hover/offer:bg-[#D4A017] group-hover/offer:text-black transition-all"
                  >
                    NÉGOCIER
                  </Button>
                </div>
        ...
        <div className="bg-[#1B4D3E]/10 border border-[#1B4D3E]/20 p-8 rounded-[3rem] space-y-4">
          <div className="flex items-center gap-4">
            ...
            <h4 className="font-black text-lg tracking-tight uppercase">
              Index des Prix Régionaux
            </h4>
          </div>
          <p className="text-sm font-bold text-[#1B4D3E]/60 leading-relaxed uppercase">
            Le maïs grain est en hausse de +2.4% cette semaine sur votre zone. L'IA recommande
            d'attendre Mardi pour les volumes &gt; 50T.
          </p>
        </div>
      </div>
    </div>
      ...
      <DialogContent className="max-w-[700px] p-0 border-none bg-white dark:bg-[#050505] rounded-[3rem] overflow-hidden shadow-3xl">
        <div className="bg-[#1B4D3E] p-10 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex justify-between items-end">
            <div className="space-y-2">
              <Badge className="bg-white/10 text-white border-white/20 font-black text-[9px] tracking-widest px-3 py-1 mb-2">
                AGRO-LISTING ENGINE v4.0
              </Badge>
              <DialogTitle className="text-4xl font-black tracking-tighter uppercase leading-none">
                NOUVELLE <span className="text-[#D4A017]">VENTE</span>
              </DialogTitle>
              <DialogDescription className="text-white/60 font-bold">
                Certification et mise sur le marché synchronisées.
              </DialogDescription>
            </div>
          ...
          <AnimatePresence mode="wait">
              ...
              >
                <div className="grid gap-6">
                  <div className="space-y-3">
                    <Label className="uppercase text-[10px] font-black text-slate-400 tracking-widest ml-2">
                      Type de Culture
                    </Label>
                      ...
                      {['Blé', 'Maïs', 'Soja', 'Tournesol', 'Riz', 'Coton'].map((c) => (
                        <button
                          ...
                          className={cn(
                            ...
                            formData.crop === c
                              ? 'bg-[#1B4D3E] text-white border-[#1B4D3E] shadow-xl'
            ...
            {step === 2 && (
              ...
              >
                <div className="space-y-6">
                  <Label className="uppercase text-[10px] font-black text-slate-400 tracking-widest ml-2">
                    Certification Qualité & Traçabilité
                  </Label>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] font-bold text-slate-400">
                            Ajoute une plus-value de +20% sur le marché.
                          </p>
                        </div>
                      </div>
                      <div
                        className={cn(
                          ...
                          formData.bio ? 'border-emerald-500 bg-emerald-500' : 'border-slate-200'
                        )}
                      >
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-black uppercase text-sm">
                            Traçabilité Blockchain Active
                          </p>
                          <p className="text-[10px] font-bold text-slate-400">
                            Garantit l’origine et les conditions de stockage.
                          </p>
                        </div>
                      </div>
                      <div
                        className={cn(
                          'h-6 w-6 rounded-full border-4 flex items-center justify-center',
                          formData.blockchain ? 'border-blue-500 bg-blue-500' : 'border-slate-200'
                        )}
                      >
            ...
            {isAnalyzing && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="py-20 flex flex-col items-center justify-center space-y-8 text-center"
              >
                <div className="relative">
                ...
                <div className="space-y-2">
                  <h3 className="text-2xl font-black uppercase tracking-tighter">
                    ANALYSE PRÉDICTIVE DU PRIX
                  </h3>
                  <p className="text-slate-400 font-bold text-sm uppercase tracking-widest">
                    L'IA AgroDeep scanne les flux mondiaux pour vous...
                  </p>
                </div>
              </motion.div>
            )}
            ...
            {step === 3 && !isAnalyzing && (
              ...
              >
                <div className="bg-[#D4A017]/10 p-10 rounded-[3rem] border border-[#D4A017]/20 text-center space-y-4">
                  <p className="text-xs font-black text-[#D4A017] uppercase tracking-[0.4em]">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <Button
                      variant="ghost"
                      className="absolute right-4 top-1/2 -translate-y-1/2 h-12 px-6 rounded-2xl bg-[#D4A017] text-black font-black"
                    >
                      ADOPTER SUGGESTION
                    </Button>
                  </div>
              ...
              >
                <div className="bg-[#0a1f18] p-10 rounded-[3rem] border border-white/5 space-y-10 relative overflow-hidden">
                  ...
                  <div className="space-y-2 relative z-10 text-center">
                    <p className="text-[#D4A017] font-black text-xs uppercase tracking-[0.5em]">
                      RÉSUMÉ DU LISTING
                    </p>
                    <h3 className="text-5xl font-black text-white tracking-tighter uppercase">
                      {formData.crop} PREMIUM
                    </h3>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-6 relative z-10">
                    ...
                    <div className="bg-white/5 p-6 rounded-2xl space-y-1">
                      ...
                      <p className="text-2xl font-black text-[#D4A017]">
                        {(formData.quantity * 245).toLocaleString()} €
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-3 justify-center relative z-10">
                    {formData.bio && (
                      <Badge className="bg-emerald-500 text-white font-black px-4 py-2 rounded-full">
                        CERTIFIÉ BIO
                      </Badge>
                    )}
                    {formData.blockchain && (
                      <Badge className="bg-blue-600 text-white font-black px-4 py-2 rounded-full">
                        BLOCKCHAIN SYNC
                      </Badge>
                    )}
                    <Badge className="bg-white/10 text-white font-black px-4 py-2 rounded-full">
                      AUDIT AGRODEEP OK
                    </Badge>
                  </div>
                </div>
        ...
        <div className="p-10 pt-0 flex justify-between gap-4">
          {step > 1 && !isAnalyzing && (
            <Button
              ...
              className="text-slate-400 font-black h-16 px-8 rounded-2xl"
            >
              RETOUR
            </Button>
          )}
          {step < 4 ? (
            !isAnalyzing && (
              ...
              >
                {step === 3 ? 'FINALISER LE DOSSIER' : 'CONTINUER'}{' '}
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 pb-4">
        <div className="space-y-2">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
            <Badge className="bg-[#D4A017] text-white px-4 py-1.5 rounded-full font-black text-[10px] tracking-widest mb-4">
              ESPACE B2B CERTIFIÉ
            </Badge>
          </motion.div>
          ...
          <p className="text-slate-500 font-bold uppercase text-[11px] tracking-[0.4em] mt-2">
            Gestion Commerciale & Logistique Haute-Précision
          </p>
        </div>
        <div className="flex gap-4">
          <Button
            onClick={() => setIsLogisticsOpen(true)}
            className="bg-black text-white hover:bg-slate-900 rounded-2xl h-16 px-8 font-black shadow-2xl transition-all hover:scale-105 flex gap-3"
          >
            <Truck className="h-5 w-5 text-[#D4A017]" /> LOGISTIQUE OPTIMISÉE
          </Button>
          <Button
            onClick={() => setIsListingOpen(true)}
            className="bg-[#1B4D3E] hover:bg-[#1B4D3E]/90 text-white rounded-2xl h-16 px-8 font-black shadow-2xl transition-all hover:scale-105 flex gap-3"
          >
        ...
        <AnimatePresence mode="wait">
          <TabsContent value="inventory" key="inventory">
            ...
            >
              ...
              <Card
                onClick={() => setIsListingOpen(true)}
                className="bg-slate-50 dark:bg-white/2 border-dashed border-2 border-slate-200 dark:border-white/10 rounded-[3rem] p-12 text-center group cursor-pointer hover:border-[#D4A017]/40 transition-all"
              >
                <div className="max-w-md mx-auto space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-slate-400 font-bold text-sm">
                      Référencez vos nouvelles récoltes certifiées par AgroDeep.
                    </p>
                  </div>
                </div>
              </Card>
            ...
            >
              <div className="flex items-center justify-between mb-8">
                <h3 className="text-3xl font-black uppercase tracking-tighter">
                  SUIVI DES <span className="text-[#D4A017]">FLUX</span> D'EXPÉDITION
                </h3>
                <div className="flex gap-4">
                  <Badge className="bg-slate-100 dark:bg-white/5 text-slate-500 font-black px-4 py-2 rounded-full">
                    EN COURS: 2
                  </Badge>
                  <Badge className="bg-emerald-100 text-emerald-700 font-black px-4 py-2 rounded-full">
                    TERMINÉES: 142
                  </Badge>
                </div>
              </div>
