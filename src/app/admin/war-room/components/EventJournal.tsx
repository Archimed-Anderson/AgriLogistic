...
import { FileText, Terminal, Download, ChevronDown } from 'lucide-react';
...
const INITIAL_LOGS: LogEntry[] = [
  {
    ...
    level: 'info',
    source: 'AUTH_SVC',
    message: 'Token JWT généré pour USER_842.',
  },
  {
    id: '2',
    timestamp: '19:42:05',
    level: 'error',
    source: 'DB_POSTGRES',
    message: 'Connexion refusée par le réplica de lecture.',
  },
  {
    id: '3',
    timestamp: '19:42:08',
    level: 'security',
    source: 'API_GW',
    message: "Tentative d'intrusion brute-force détectée (IP_124.5.x.x).",
  },
  {
    id: '4',
    timestamp: '19:42:12',
    level: 'warn',
    source: 'LOGISTIC_CORE',
    message: 'Temps de réponse élevé sur le trajet DAK-THS.',
  },
];
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      const newLog: LogEntry = {
        ...
        message: `Événement système automatisé détecté sur ${
      ...
      <div className="p-6 border-b border-border bg-foreground/5 flex flex-col gap-4">
        <div className="flex items-center justify-between">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="w-8 h-8 rounded-xl bg-foreground/5 hover:bg-foreground/10"
          >
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[9px] font-black text-primary/80 uppercase tracking-tight italic">
                    @ {log.source}
                  </span>
                </div>
