...
const mockTransactions: Transaction[] = [
  {
    ...
    amount: 92500,
    status: 'completed',
    date: new Date('2026-01-22T14:30:00'),
    description: 'Paiement commande AGR-2026-0001',
    orderId: 'ord-001',
    invoiceId: 'inv-001',
  ...
  },
  {
    ...
    amount: 250000,
    status: 'completed',
    date: new Date('2026-01-21T10:15:00'),
    description: 'Paiement commande AGR-2026-0002',
    orderId: 'ord-002',
    invoiceId: 'inv-002',
  ...
  },
  {
    ...
    description: 'Remboursement partiel AGR-2026-0003',
    orderId: 'ord-003',
    paymentMethod: 'Orange Money',
  },
  {
    ...
    description: 'Paiement commande AGR-2026-0004',
    orderId: 'ord-004',
    invoiceId: 'inv-003',
    paymentMethod: 'Wave',
  },
