...
import { Settings, Bell, Shield, Smartphone, Globe, Truck, Save, Database } from 'lucide-react';
      ...
      <div className="flex items-end justify-between">
        <div>
          <h1 className="text-4xl font-black text-white uppercase tracking-tighter">
            CONFIGURATION <span className="text-emerald-500">SYSTÈME</span>
          </h1>
          <p className="text-slate-500 font-bold uppercase text-[10px] tracking-[0.4em] mt-2">
            Paramètres du Command Center & Intégrations
          </p>
        </div>
        <Button
          onClick={handleSave}
        ...
        <div className="lg:col-span-3 space-y-2">
          {[
            ...
            <Button
              key={i}
              variant="ghost"
              className="w-full justify-start gap-3 h-12 rounded-xl text-slate-400 hover:text-white hover:bg-white/5 data-[active=true]:bg-emerald-500/10 data-[active=true]:text-emerald-500 font-bold"
            >
              <item.icon size={18} />
              {item.label}
            </Button>
          ...
          <Card className="bg-slate-950/40 border-white/5 shadow-2xl rounded-3xl p-8 overflow-hidden">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">
                  Connecteurs API & Nœuds Blockchain
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="p-6 bg-white/5 rounded-2xl border border-white/5 space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <Badge className="bg-orange-500/20 text-orange-500 border-orange-500/20 uppercase text-[9px] font-black">
                      OR-Tools
                    </Badge>
              ...
              <div className="p-6 bg-white/5 rounded-2xl border border-white/5 space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <Badge className="bg-blue-500/20 text-blue-500 border-blue-500/20 uppercase text-[9px] font-black">
                      Hyperledger
                    </Badge>
          ...
          <Card className="bg-slate-950/40 border-white/5 shadow-2xl rounded-3xl p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">
                  Seuils de déclenchement & canaux
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              {[
                {
                  label: 'Alertes Météo Majeures (Grêle, Orage)',
                  desc: 'Envoyer SMS aux chauffeurs concernés',
                  active: true,
                },
                {
                  label: 'Déviation Itinéraire > 10%',
                  desc: 'Notifier le centre de commande',
                  active: true,
                },
                {
                  label: 'Maintenance Critique Véhicule',
                  desc: 'Créer ticket automatique atelier',
                  active: false,
                },
              ].map((opt, i) => (
                <div
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Button
                    variant="outline"
                    className="flex-1 border-emerald-500 text-emerald-500 bg-emerald-500/10 font-bold"
                  >
                    Métrique (km, kg)
                  </Button>
                  <Button
                    variant="outline"
                    className="flex-1 border-white/10 text-slate-500 font-bold hover:bg-white/5"
                  >
                    Impérial (mi, lbs)
                  </Button>
                </div>
