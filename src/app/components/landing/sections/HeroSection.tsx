        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="flex flex-col max-w-2xl relative z-10">
            ...
            <p className="text-lg font-normal text-slate-500 mb-8 leading-relaxed max-w-lg">
              ...
              <strong className="font-bold text-slate-700"> IA</strong> pour booster votre rendement.
            </p>
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-slate-100">
              <div>
                ...
                <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mt-1">Agriculteurs</p>
              </div>
              <div className="w-px h-10 bg-slate-200"></div>
              <div>
                <p className="text-3xl font-light text-slate-800">2.5M€</p>
                <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mt-1">Transités</p>
              </div>
              <div className="w-px h-10 bg-slate-200"></div>
              <div className="flex -space-x-3">
                 {[1,2,3,4].map(i => (
                    <div key={i} className="w-8 h-8 rounded-full border-2 border-white bg-slate-200 flex items-center justify-center text-[10px] bg-cover bg-center" style={{backgroundImage: `url(https://i.pravatar.cc/100?img=${i + 10})`}}></div>
                 ))}
                 <div className="w-8 h-8 rounded-full border-2 border-white bg-green-50 text-green-600 flex items-center justify-center text-xs font-bold">+</div>
              </div>
            </div>
          </div>
