...
import { Lazy3DBackground } from '@/components/affiliation/Lazy3DBackground';
    ...
    <div className="relative min-h-screen text-white pt-40 pb-20">
      ...
      <div className="container mx-auto px-6">
        ...
        <nav className="flex items-center gap-3 mb-16 text-[10px] font-black uppercase tracking-[0.3em] text-slate-600">
          ...
          <Link href="/affiliation" className="hover:text-yellow-500 transition-colors">
            Boutique
          </Link>
          <div className="h-1 w-1 rounded-full bg-slate-800" />
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-3 gap-8">
              {product.images.map((img, i) => (
                <div
                  key={i}
                  className="aspect-square rounded-2xl overflow-hidden border-2 border-white/10 hover:border-yellow-500 hover:scale-105 transition-all cursor-pointer bg-[#242424] relative shadow-xl"
                >
              ...
              {[...Array(Math.max(0, 3 - product.images.length))].map((_, i) => (
                <div
                  key={`pl-${i}`}
                  className="aspect-square rounded-2xl bg-white/5 border-2 border-dashed border-white/10 flex items-center justify-center"
                >
          ...
          <div className="flex flex-col pt-4">
            ...
            <div className="flex items-center gap-8 mb-10">
              <div className="flex items-center text-yellow-500 text-2xl font-black tracking-tighter">
                ...
                {product.rating}
                <span className="text-slate-600 text-xs ml-3 font-black uppercase tracking-widest">
            ...
            <div className="bg-[#242424]/80 backdrop-blur-md border-2 border-white/5 p-10 rounded-[40px] mb-16 relative overflow-hidden group shadow-2xl">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-10 mb-10">
                <div>
                  <div className="text-slate-500 text-[10px] font-black uppercase mb-2 tracking-[0.3em]">
                    Offre Partenaire {product.platform}
                  </div>
                  <div className="flex items-center gap-6">
                    ...
                    {product.originalPrice && (
                      <span className="text-3xl text-slate-700 line-through font-black italic">
                ...
                <div className="bg-orange-500/10 border border-orange-500/30 p-5 rounded-3xl flex items-center gap-5 shadow-2xl shadow-orange-500/5">
                  ...
                  <div>
                    ...
                    <div className="text-orange-500 font-black text-lg tracking-tighter">
                      -14% vs Public
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  {product.pros.map((pro, i) => (
                    <div
                      key={i}
                      className="flex items-start gap-5 bg-emerald-500/5 p-5 rounded-2xl border border-emerald-500/10 hover:bg-emerald-500/10 transition-colors"
                    >
                      <div className="h-2 w-2 rounded-full bg-emerald-500 mt-2 shrink-0" />
                      <span className="text-sm font-black text-slate-300 leading-tight uppercase">
                        {pro}
                      </span>
                    </div>
                  ))}
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  {product.cons.map((con, i) => (
                    <div
                      key={i}
                      className="flex items-start gap-5 bg-orange-600/5 p-5 rounded-2xl border border-orange-600/10 hover:bg-orange-600/10 transition-colors grayscale opacity-70"
                    >
              ...
              {product.features.map((feature, i) => (
                <div key={i} className="group relative">
                  ...
                  <div className="relative flex items-center gap-6 p-10 bg-[#242424]/50 border-2 border-white/5 rounded-[32px] hover:border-yellow-500/30 transition-all shadow-xl group-hover:scale-105 duration-500">
                    ...
                    <span className="font-black uppercase text-base tracking-tighter leading-[1.1] italic">
                      {feature}
                    </span>
                  </div>
                </div>
        ...
        {similarProducts.length > 0 && (
          <section className="space-y-20 py-32 border-t border-white/5 relative bg-gradient-to-b from-[#1a1a1a] to-[#141414]">
            <div className="flex items-center justify-between">
              ...
              >
                Toutes les offres{' '}
                <div className="h-12 w-12 rounded-2xl border-2 border-yellow-500/30 flex items-center justify-center group-hover:bg-yellow-500 group-hover:text-black transition-all group-hover:scale-110 shadow-2xl">
                  →
                </div>
              </Link>
            </div>
