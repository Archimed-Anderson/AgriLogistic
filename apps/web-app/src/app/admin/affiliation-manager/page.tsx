...
export default function AffiliationManagerPage() {
  ...
  const handleTogglePromo = (id: string) => {
    setProducts((prev) =>
      prev.map((p) => (p.id === id ? { ...p, discount: p.discount ? 0 : 20 } : p))
    );
  };
    ...
    <div className="min-h-screen bg-[#0a0c10] text-white p-8 relative overflow-hidden">
      ...
      <Tabs defaultValue="inventory" className="space-y-8">
        <TabsList className="bg-slate-900/50 border border-slate-800 p-1 rounded-2xl h-14 w-fit">
          <TabsTrigger
            value="inventory"
            className="rounded-xl px-8 font-black uppercase text-xs tracking-widest data-[state=active]:bg-yellow-500 data-[state=active]:text-black"
          >
            Inventaire
          </TabsTrigger>
          <TabsTrigger
            ...
            <Table>
              <TableHeader className="bg-slate-800/30">
                <TableRow className="border-slate-800 hover:bg-transparent">
                  <TableHead className="w-[80px] text-slate-500 font-black uppercase text-[10px] tracking-widest">
                    Image
                  </TableHead>
                  <TableHead className="text-slate-500 font-black uppercase text-[10px] tracking-widest">
                    Produit
                  </TableHead>
                  <TableHead className="text-slate-500 font-black uppercase text-[10px] tracking-widest">
                    Plateforme
                  ...
                  <TableHead className="text-right text-slate-500 font-black uppercase text-[10px] tracking-widest">
                    Actions
                  </TableHead>
                </TableRow>
              </TableHeader>
                  ...
                  >
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent
                          align="end"
                          className="bg-slate-900 border-slate-800 text-white w-48 rounded-2xl p-2 shadow-2xl"
                        >
                          <DropdownMenuLabel className="text-[10px] font-black uppercase text-slate-500 px-2 py-2">
                            Options
                          </DropdownMenuLabel>
                          <DropdownMenuItem
                            className="rounded-xl focus:bg-yellow-500 focus:text-black font-bold cursor-pointer transition-colors"
                            onClick={() => {
                          ...
                          <DropdownMenuItem
                            className="rounded-xl focus:bg-blue-500 focus:text-white font-bold cursor-pointer transition-colors"
                            asChild
                          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-3xl backdrop-blur-md">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input
                    defaultValue="Boutique Partenaires AgriLogistic"
                    className="bg-slate-800/50 border-slate-700 rounded-xl"
                  />
                </div>
                <div className="space-y-2">
                  <Label className="text-[10px] font-black uppercase text-slate-500 tracking-widest">
                    ID Tracking Amazon Associé
                  </Label>
                  <Input
                    defaultValue="agrilogistic-21"
                    className="bg-slate-800/50 border-slate-700 rounded-xl"
                  />
                </div>
                <div className="space-y-2">
            ...
            <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-3xl backdrop-blur-md">
              ...
              <p className="text-slate-400 text-sm font-bold mb-6">
                Actions irréversibles sur le module d'affiliation.
              </p>
              <div className="space-y-4">
                <Button
                  variant="outline"
                  className="w-full h-14 border-red-500/30 text-red-500 hover:bg-red-500 hover:text-white font-black uppercase tracking-widest rounded-xl transition-all"
                >
          ...
          <form onSubmit={handleSaveProduct}>
            <div className="bg-slate-800/50 p-8 border-b border-slate-700">
              <DialogTitle className="text-3xl font-black uppercase tracking-tighter italic flex items-center gap-3">
                ...
                {editingProduct ? 'Éditer le' : 'Nouveau'}{' '}
                <span className="text-yellow-500">Produit</span>
              </DialogTitle>
            ...
            <div className="p-8 space-y-6 max-h-[60vh] overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-slate-800/50 border-slate-700 rounded-xl py-6"
                    placeholder="ex: Drone DJI Agras T30"
                    required
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <select
                    className="flex h-12 w-full items-center justify-between rounded-xl border border-slate-700 bg-slate-800/50 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-500/20 font-bold uppercase tracking-tight"
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <select
                    className="flex h-12 w-full items-center justify-between rounded-xl border border-slate-700 bg-slate-800/50 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-500/20 font-bold uppercase tracking-tight"
                    defaultValue={editingProduct?.platform}
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="h-12 border-slate-700 text-slate-500"
                  >
              ...
              <div className="pt-6 border-t border-slate-800 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    defaultValue={editingProduct?.seo?.title}
                    className="bg-slate-800/50 border-slate-700 rounded-xl py-6"
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-slate-800/50 border-slate-700 rounded-xl py-6"
                      placeholder="robotique, drone, agritech..."
                    />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase text-slate-500 tracking-widest">
                      ID Tracking Spécifique
                    </Label>
                    <Input
                      defaultValue={editingProduct?.trackingId}
                      className="bg-slate-800/50 border-slate-700 rounded-xl py-6"
                      placeholder="ex: tag-21"
                    />
                  </div>
                </div>
              </div>
            ...
            <DialogFooter className="bg-slate-800/50 p-8 border-t border-slate-700 mt-0">
              <Button
                ...
                className="h-14 px-8 font-black uppercase tracking-widest text-slate-500 hover:text-white"
              >
                Annuler
              </Button>
              <Button
                type="submit"
                className="h-14 px-12 bg-yellow-500 hover:bg-yellow-600 text-black font-black uppercase tracking-widest rounded-2xl shadow-xl shadow-yellow-500/20"
              >
