...
import { criticalAlerts, getAlertsBySeverity, type CriticalAlert } from '@/data/crop-intelligence-data'
  ...
  if (activeAlerts.length === 0 && !showResolved) {
    return (
      <div className="bg-emerald-50/30 rounded-3xl p-8 border border-emerald-200">
        ...
        <p className="text-emerald-700 font-medium">✨ Aucune alerte active. Toutes les zones sont surveillées et fonctionnent normalement.</p>
      </div>
    )
  }
  ...
  return (
    <div className="bg-white rounded-3xl p-8 border border-slate-200 hover:shadow-2xl transition-all duration-300">
      ...
      <div className="flex items-start justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className={`p-3 rounded-xl shadow-lg relative ${
            showResolved ? 'bg-linear-to-br from-slate-500 to-slate-600' : 'bg-linear-to-br from-red-500 to-rose-600'
          }`}>
        ...
        {displayedAlerts.map((alert) => (
          ...
          >
            ...
            <div className="flex items-start gap-4">
              {/* Icon */}
              <div className={`shrink-0 p-3 rounded-xl ${getAlertIconBg(alert.severity)} shadow-lg`}>
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 text-xs text-slate-500">
                  ...
                  <span className="font-medium">
                    Détecté: {new Date(alert.detectedAt).toLocaleString('fr-FR', {
                      day: '2-digit',
                      month: 'short',
                      hour: '2-digit',
                      minute: '2-digit'
