...
import { Zap, Shield, Box, Plus, Users, Download, Settings } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 flex flex-col gap-8">
          ...
          <div className="flex-1 bg-card/40 backdrop-blur-xl border border-border rounded-[40px] p-8 relative overflow-hidden group">
            ...
            <h4 className="text-sm font-black text-foreground uppercase tracking-tighter mb-2">
            ...
            <Button
              variant="outline"
              className="w-full rounded-2xl border-border bg-foreground/5 h-12 text-[10px] font-black uppercase tracking-widest gap-2"
            >
...
function QuickActionPanel() {
  ...
  return (
    <div className="bg-card/40 backdrop-blur-xl border border-border rounded-[40px] p-8 flex flex-col justify-between shadow-lg">
      <h4 className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-6">
        Actions Rapides
      </h4>
      <div className="space-y-4">
        {actions.map((action, i) => (
          <button
            key={i}
            className="w-full flex items-center justify-between p-4 rounded-2xl bg-foreground/5 border border-border/50 hover:bg-foreground/10 transition-all group"
          >
        ...
        <div>
          <div className="flex justify-between items-end mb-2">
            ...
            <p className="text-xl font-black text-foreground tabular-nums">
              {metrics.health.score.toFixed(2)}%
            </p>
          </div>
      ...
      <div className="flex items-center gap-1.5 mb-1">
        <div
          className={cn(
            ...
            active ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)]' : 'bg-muted'
          )}
        />
