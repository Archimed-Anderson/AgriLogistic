...
import { ShieldCheck, Lock, Zap, Database, Users as UsersIcon, Settings } from 'lucide-react';
...
const PERMISSIONS: Permission[] = [
  {
    ...
    category: 'Analytics',
    description: 'Accès aux rapports et KPIs profonds',
  },
  {
    id: '2',
    name: 'Can Export Finances',
    category: 'Finances',
    description: 'Extraction des journaux de transactions',
  },
  {
    id: '3',
    name: 'Can Manage Users',
    category: 'Users',
    description: 'Suspendre ou modifier les comptes',
  },
  {
    id: '4',
    name: 'Can Access CLI',
    category: 'System',
    description: "Accès au terminal d'administration",
  },
];
            ...
            <div className="flex items-center gap-4 mb-2">
              ...
              <div>
                ...
                <DialogDescription className="text-[10px] text-muted-foreground font-black uppercase tracking-widest mt-1">
                  Modifier les privilèges de : <span className="text-foreground">{user.name}</span>{' '}
                  ({user.id})
                </DialogDescription>
              </div>
            </div>
