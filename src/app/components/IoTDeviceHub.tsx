...
export function IoTDeviceHub() {
  const [activeView, setActiveView] = useState<
    'overview' | 'devices' | 'network' | 'battery' | 'alerts' | 'analytics'
  >('overview');
        ...
        <div className="bg-card border rounded-xl p-6">
          ...
          <div className="space-y-3">
            {[
              ...
              {
                time: 'Il y a 15 min',
                action: 'IOT-003 - Alerte batterie faible',
                status: 'warning',
              },
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Optimisez la durée de vie et planifiez les remplacements
        </p>
      </div>
        ...
        {[
          ...
          return (
            <div key={index} className="bg-card border rounded-xl p-6">
              <div className="flex items-start justify-between mb-4">
                <div
                  className={`p-3 rounded-lg bg-${status.color}-100 dark:bg-${status.color}-900/20`}
                >
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Gérez et surveillez votre écosystème IoT agricole</p>
        </div>
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all whitespace-nowrap ${
                activeView === tab.id ? 'bg-[#4682B4] text-white' : 'hover:bg-muted'
              }`}
            >
