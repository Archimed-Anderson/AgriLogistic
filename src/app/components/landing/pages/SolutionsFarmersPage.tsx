...
const faqData: FAQItem[] = [
  {
    ...
    answer: "L'agriculture représente environ 70% de l'utilisation mondiale d'eau douce. Nos solutions permettent d'optimiser l'irrigation et de réduire significativement la consommation d'eau grâce à l'analyse de données en temps réel."
  },
  {
    question: "Émissions élevées de GES des systèmes alimentaires",
    answer: "Les systèmes alimentaires sont responsables d'environ 1/3 des émissions mondiales de gaz à effet de serre. Nous aidons les agriculteurs à adopter des pratiques plus durables pour réduire leur empreinte carbone."
  },
  {
    question: "Déforestation à grande échelle due à l'expansion agricole",
    answer: "90% de la déforestation est liée à l'expansion agricole. Notre technologie permet d'optimiser l'utilisation des terres existantes et de prévenir l'expansion destructrice."
  },
  {
    question: "Perte de rendement liée au climat",
    answer: "Le changement climatique affecte directement les rendements agricoles. Nos outils d'intelligence artificielle prévoient les risques climatiques et aident à adapter les pratiques culturales."
  },
  {
    question: "Faible adoption des pratiques agricoles intelligentes",
    answer: "Nous facilitons la transition vers l'agriculture intelligente grâce à des outils numériques accessibles et un accompagnement personnalisé pour chaque exploitation."
  }
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in">
              ...
              <p className="text-lg text-gray-300 mb-8 max-w-xl leading-relaxed">
                Construisez un avenir plus vert et plus résilient grâce à l'intelligence de durabilité 
                alimentée par l'IA pour les exploitations agricoles et les chaînes d'approvisionnement alimentaire.
              </p>
              <button
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="bg-[#0d2818] rounded-lg p-4">
                      ...
                      <div className="w-full h-2 bg-gray-700 rounded-full mt-2">
                        <div className="h-full rounded-full" style={{ width: '85%', backgroundColor: '#8BC34A' }} />
                      </div>
                    </div>
                    <div className="bg-[#0d2818] rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Le changement climatique est l'un des plus grands défis auxquels l'humanité est confrontée aujourd'hui, 
                et l'agriculture se trouve au cœur de cette crise.
              </p>
              <p className="text-gray-600 leading-relaxed mb-6">
                D'un côté, le changement climatique est le plus grand perturbateur de l'agriculture mondiale. 
                De l'autre, l'agriculture elle-même contribue de manière significative à la crise.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Transformer les pratiques agricoles pour qu'elles soient durables, respectueuses du climat et responsables 
                est une priorité absolue pour les gouvernements, les organisations multilatérales et les entreprises 
                agroalimentaires du monde entier.
              </p>
            </div>
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Découvrez pourquoi il y a un besoin urgent de solutions agricoles plus intelligentes avec ces 
              statistiques clés qui révèlent l'impact réel du changement climatique sur l'agriculture.
            </p>
          </div>
          ...
          <div className="mb-12">
            <div className="bg-white rounded-2xl shadow-lg p-8 max-w-3xl mx-auto">
              ...
              <p className="text-center text-gray-600">La surface terrestre utilisée pour l'agriculture</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <p className="text-gray-600">Les émissions mondiales de GES sont causées par les systèmes alimentaires</p>
            </div>
            <div className="bg-white rounded-xl shadow-md p-6">
              <p className="text-4xl font-bold text-gray-900 mb-2">90%</p>
              <p className="text-gray-600">Le taux de déforestation est le résultat de l'expansion agricole</p>
            </div>
            <div className="bg-white rounded-xl shadow-md p-6">
              <p className="text-4xl font-bold text-gray-900 mb-2">-40%</p>
              <p className="text-gray-600">Baisse prévue des rendements agricoles due au changement climatique</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            ...
            <div className="lg:col-span-1">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6 leading-tight">
                Solutions technologiques pour un avenir <span style={{ color: '#8BC34A' }}>résilient et régénératif</span>
              </h2>
              <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                Chez AgroLogistic, nous permettons cette transition plus rapidement et plus efficacement grâce à nos solutions technologiques de pointe. 
                Associez-vous à nous pour construire un avenir agricole durable et intelligent face au climat.
              </p>
            </div>
