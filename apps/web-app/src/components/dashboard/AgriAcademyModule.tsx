...
const COURSES = [
  ...
  },
  {
    ...
    level: 'Avancé',
    thumbnail:
      'https://images.unsplash.com/photo-1542332213-31f873480a71?auto=format&fit=crop&q=80&w=800',
    modules: [
  ...
  },
  {
    ...
    level: 'Stratégique',
    thumbnail:
      'https://images.unsplash.com/photo-1454165833767-027ffea7028c?auto=format&fit=crop&q=80&w=800',
    modules: [
...
function LearningPathViewer({ onSelectNode }: { onSelectNode: (course: any) => void }) {
  return (
    <div className="relative py-20 overflow-hidden">
      ...
      <svg
        className="absolute top-0 left-1/2 -translate-x-1/2 w-[400px] h-full pointer-events-none opacity-10"
          ...
          return (
            ...
            >
                ...
                {isLocked ? (
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute -top-10 -right-10">
                      <Badge className="bg-[#D4A017] text-white border-none text-[8px] font-black">
                        {progress}%
                      </Badge>
                    </div>
                  </div>
              ...
              >
                <Badge
                  variant="outline"
                  className="border-[#D4A017]/30 text-[#D4A017] uppercase text-[9px] tracking-widest leading-none px-3 py-1 font-black bg-[#D4A017]/5"
                >
                  {course.level}
                </Badge>
    ...
    <div className="grid lg:grid-cols-12 gap-12 items-start">
      <div className="lg:col-span-8 space-y-8">
        <div className="relative rounded-[3rem] overflow-hidden shadow-3xl bg-black aspect-video group border border-white/5">
          ...
          >
            <source
              src="https://assets.mixkit.co/videos/preview/mixkit-farmer-walking-in-a-field-at-sunset-1200-preview.mp4"
              type="video/mp4"
            />
          </video>
          ...
          <div className="absolute top-8 right-8 flex gap-3 opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0 duration-300">
            <Button
              onClick={addBookmark}
              className="bg-white/10 backdrop-blur-xl border border-white/20 hover:bg-white/20 text-white rounded-2xl flex gap-2 font-black text-xs uppercase"
            >
        ...
        <div className="flex items-center justify-between p-10 bg-white/2 backdrop-blur-3xl rounded-[3rem] border border-white/5 shadow-2xl">
          <div className="space-y-2">
            ...
            <div className="flex gap-6 text-slate-500 text-xs font-bold uppercase tracking-widest">
              <span className="flex items-center gap-2 text-[#D4A017]">
                <Clock size={14} /> {course.duration}
              </span>
              <span className="flex items-center gap-2">
                <Video size={14} /> 12 Modules
              </span>
              <span className="flex items-center gap-2">
                <Star size={14} className="fill-[#D4A017] text-[#D4A017]" /> 4.9/5
              </span>
            </div>
          </div>
            ...
            {bookmarks.length === 0 ? (
              ...
              bookmarks.map((bm, i) => (
                <motion.div
                  ...
                  onClick={() => {
                    if (videoRef.current) videoRef.current.currentTime = bm.time;
                  }}
                >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-white/60 text-sm font-bold leading-relaxed">
                Terminez ce cours à 100% pour débloquer votre certificat NFT vérifiable sur la
                blockchain AgriLogistic.
              </p>
            </div>
            {/* @ts-ignore */}
            <Progress
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 py-10">
      <div className="text-center space-y-4">
        <Badge className="bg-[#D4A017] text-white px-6 py-2 rounded-full font-black text-xs tracking-widest uppercase">
          Examen de Certification
        </Badge>
        <h2 className="text-6xl font-black text-white tracking-tighter leading-none uppercase">
          PROUVEZ VOTRE <span className="text-[#D4A017]">MAÎTRISE</span>
        </h2>
        <p className="text-slate-500 font-bold uppercase text-[11px] tracking-[0.4em]">
          Validation des acquis par intelligence artificielle
        </p>
      </div>
      ...
      <Card className="bg-white/2 backdrop-blur-3xl border-white/10 border-none shadow-3xl rounded-[4rem] overflow-hidden p-16 space-y-12">
        <div className="space-y-8">
          <div className="flex justify-between items-end border-b border-white/10 pb-8">
            <div className="space-y-2">
              <p className="text-[#D4A017] font-black text-xs uppercase tracking-widest">
                Question 1 sur 3
              </p>
              <h3 className="text-3xl font-black text-white tracking-tighter">
                Quel est l'indice NDVI optimal pour déclencher une irrigation de précision sur le
                blé au stade floraison ?
              </h3>
            </div>
          ...
          <div className="grid gap-6">
            {[
              ...
              >
                <span className="text-lg font-black text-white group-hover:text-[#D4A017] transition-colors">
                  {opt}
                </span>
        ...
        <DialogContent className="max-w-[800px] p-0 border-none bg-white dark:bg-[#0a0a0a] rounded-[3.5rem] overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.8)]">
          <div className="relative p-20 text-center space-y-12 overflow-hidden bg-gradient-to-br from-[#0a0a0a] to-[#000]">
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="space-y-2">
                <p className="text-[#D4A017] font-black text-sm uppercase tracking-[0.6em]">
                  CERTIFICAT DE RÉUSSITE
                </p>
                <h3 className="text-6xl font-black text-white tracking-tighter uppercase leading-none">
                  MAÎTRE <span className="text-[#D4A017]">IRRIGUANT</span>
                </h3>
              </div>
            </div>
            ...
            <div className="space-y-8 relative z-10">
              <p className="text-slate-400 font-bold text-xl leading-relaxed">
                ...
                <span className="text-white underline decoration-[#D4A017] decoration-4 underline-offset-8">
                  Jean Dupont
                </span>{' '}
                a complété avec succès le module expert sur <br />
              ...
              <div className="flex justify-center gap-12 pt-8">
                <div className="text-center">
                  ...
                  <p className="text-white font-black text-xs bg-white/5 py-2 px-6 rounded-full border border-white/10 tracking-widest uppercase">
                    AD-7742-BL-2024
                  </p>
                </div>
                <div className="text-center">
            ...
            <div className="pt-12 flex gap-4 relative z-10">
              ...
              <Button
                variant="outline"
                className="h-16 w-16 rounded-2xl border-white/10 hover:bg-white/5 text-white shadow-2xl transition-all"
              >
                <Share2 size={20} />
              </Button>
            </div>
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-12">
          <div className="space-y-6 max-w-2xl">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
              <Badge className="bg-[#1B4D3E] text-[#D4A017] px-6 py-2 rounded-full font-black text-xs tracking-[0.3em] border border-[#D4A017]/20 uppercase mb-4">
                ACADÉMIE_PLATINIUM v2.0
              </Badge>
            </motion.div>
          ...
          >
            ...
            <div className="lg:col-span-8 space-y-12">
                ...
                <div className="relative z-10 p-12">
                  <div className="flex items-center justify-between mb-20">
                    <h2 className="text-4xl font-black text-white italic tracking-tighter uppercase">
                      PARCOURS <span className="text-[#D4A017]">CERTIFIANT</span>
                    </h2>
                    <div className="flex items-center gap-4">
                      <div className="flex -space-x-4">
                        {[1, 2, 3].map((v) => (
                          <div
                            key={v}
                            className="h-10 w-10 rounded-full border-4 border-[#050505] bg-slate-800"
                          />
                        ))}
                      </div>
                      <p className="text-[10px] font-black text-slate-500 uppercase">
                        +150 collègues apprennent ici
                      </p>
                    </div>
                  </div>
              ...
              <div className="space-y-8">
                <div className="flex items-center justify-between px-6">
                  ...
                  <Button
                    variant="link"
                    className="text-[#D4A017] font-black text-xs uppercase tracking-widest"
                  >
                    Tout voir
                  </Button>
                </div>
                <div className="grid md:grid-cols-3 gap-6">
                  {ARTICLES.map((article) => (
                    <Card
                      key={article.id}
                      className="bg-[#050505] border-white/5 overflow-hidden group hover:border-[#D4A017]/30 transition-all cursor-pointer rounded-[2.5rem]"
                    >
                      <div className="h-48 overflow-hidden relative">
                        ...
                        />
                        <Badge className="absolute top-4 left-4 bg-black/60 backdrop-blur-md text-white border-none font-black text-[9px] px-3">
                          {article.category}
                        </Badge>
                      </div>
                      <CardHeader className="p-6">
                        ...
                        <CardTitle className="text-lg font-black text-white leading-tight group-hover:text-[#D4A017] transition-colors">
                          {article.title}
                        </CardTitle>
                      </CardHeader>
                    </Card>
            ...
            <div className="lg:col-span-4 space-y-10 h-fit lg:sticky lg:top-10">
              ...
              <Card className="bg-gradient-to-br from-[#1B4D3E] to-[#0a1f18] border-none shadow-3xl rounded-[3.5rem] p-10 relative overflow-hidden group">
                ...
                <div className="relative z-10 space-y-8">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <p className="text-[#D4A017] font-black text-xs uppercase tracking-[0.2em]">
                        STATUT_EXPERT
                      </p>
                  ...
                  <Button
                    ...
                    className="w-full bg-white text-black hover:bg-[#D4A017] transition-all rounded-2xl h-16 font-black uppercase text-xs tracking-widest shadow-2xl"
                  >
                    VALIDER UN EXAMEN
                  </Button>
                </div>
              ...
              <Card className="bg-[#050505] border-white/5 shadow-3xl rounded-[3rem] p-8 space-y-6">
                ...
                <div className="space-y-4">
                  {LEADERBOARD.map((user) => (
                    ...
                    >
                      ...
                      <span className="text-[10px] font-black text-[#D4A017] tabular-nums">
                ...
                <Button
                  variant="ghost"
                  className="w-full text-slate-500 hover:text-white font-black text-[10px] uppercase"
                >
              ...
              <div className="relative group overflow-hidden rounded-[3.5rem] border border-white/5 aspect-[4/5]">
                ...
                <div className="absolute bottom-10 left-10 right-10 space-y-6">
                  <Badge className="bg-[#D4A017] text-black border-none font-black text-[10px] uppercase tracking-widest px-4 py-1.5">
                    LIVE_MASTERCLASS
                  </Badge>
                  <div>
                    <h4 className="text-3xl font-black text-white tracking-tighter uppercase leading-[0.9]">
                      SOLS VIVANTS AVEC DR. ARIS
                    </h4>
                    <p className="text-slate-400 text-xs font-bold mt-2 uppercase tracking-widest">
                      Demain à 18:00 (CET)
                    </p>
                  </div>
                  <Button className="w-full bg-[#1B4D3E] hover:bg-emerald-700 text-white rounded-2xl h-14 font-black text-xs uppercase tracking-widest transition-all shadow-2xl">
                    RÉSERVER MA PLACE
                  </Button>
                </div>
              </div>
