...
const features = [
  {
    ...
    description:
      "Visualisez vos stocks et prévoyez la demande grâce à nos algorithmes d'IA de pointe.",
    icon: TrendingUp,
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1526772662000-3f88f10c053b?auto=format&fit=crop&w=800',
      ...
      <div className="container px-6 mx-auto relative z-10">
        <div className="max-w-3xl mb-24">
          ...
          <h2 className="text-5xl md:text-7xl font-black text-slate-950 mb-8 tracking-tight leading-[1.1]">
            Une technologie <span className="text-emerald-600 italic">robuste</span> pour un impact
            réel.
          </h2>
          <p className="text-slate-600 text-xl font-bold leading-relaxed max-w-xl">
            Nous avons fusionné l'IA de pointe, la blockchain et l'IoT pour créer l'écosystème
            agricole le plus puissant au monde.
          </p>
        </div>
