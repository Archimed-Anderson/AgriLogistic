...
function AppShell() {
  ...
  const deny = (moduleLabel: string) => (
    <AccessDenied
      ...
      onBack={() =>
        handleNavigate(getSidebarType() === 'admin' ? '/admin/dashboard' : '/customer/dashboard')
      }
    />
  );
    ...
    switch (currentRoute) {
          ...
          <ProjectDetailPage
            ...
            content={
              <>
                ...
                <p>
                  Have a question about our platform, services, or pricing? Our team is ready to
                  provide you with the answers you need to get started.
                </p>
          ...
          <ProjectDetailPage
            ...
            content={
              <>
                <h2>Grow With Us</h2>
                <p>
                  We are always looking to collaborate with organizations that share our vision for
                  a sustainable agricultural future. Let's build something great together.
                </p>
          ...
          <ProjectDetailPage
            ...
            content={
              <>
                ...
                <p>
                  We believe that high-yield agriculture shouldn't come at the cost of the
                  environment. Our eco-friendly practices focus on regenerative agriculture,
                  ensuring soil health and biodiversity are maintained.
                </p>
                <h3>Key Synergies</h3>
                <ul>
                  <li>
                    Regenerative Soil Management: Using cover crops and composting to sequester
                    carbon.
                  </li>
                  <li>
          ...
          <ProjectDetailPage
            ...
            content={
              <>
                ...
                <p>
                  AgroLogistic cuts out the middlemen, connecting smallholder farmers directly to
                  global buyers. This ensures fairer prices, transparent transactions, and faster
                  payments.
                </p>
          ...
          <ProjectDetailPage
            ...
            content={
              <>
                ...
                <p>
                  Our AI-driven analytics platform processes millions of data points daily to
                  provide actionable insights. This allows farmers to optimize planting schedules,
          ...
          <ProjectDetailPage
            ...
            content={
              <>
                ...
                <p>
                  Water is our most precious resource. Our smart irrigation systems ensure that
                  every drop counts, delivering water directly to the plant roots based on real-time
                  soil moisture data.
                </p>
          ...
          <ProjectDetailPage
            ...
            content={
              <>
                ...
                <p>
                  We help farms transition to 100% renewable energy sources. From solar panels on
                  barn roofs to wind turbines in open fields, we integrate clean energy into every
          ...
          <ProjectDetailPage
            ...
            content={
              <>
                ...
                <p>
                  We successfully expanded the operational capacity of BioFuture's main facility by
                  200%. This project included the installation of a 500kW solar array, automated
                  greenhouses, and a vertically integrated logistics hub.
                </p>
          ...
          <ProjectDetailPage
            ...
            content={
              <>
                <h2>The Challenge</h2>
                <p>
                  Water scarcity in the region demanded a revolutionary approach to crop hydration.
                  Traditional methods were wasteful and imprecise.
                </p>
                <h3>Our Solution</h3>
                <p>
                  We deployed a network of over 1000 IoT sensors connected to a central AI
                  processing unit. This system analyzes soil moisture, weather forecasts, and crop
                  health in real-time to deliver the exact amount of water needed.
                </p>
                <h3>Results</h3>
                <ul>
          ...
          <ProjectDetailPage
            ...
            content={
              <>
                <h2>Project Scope</h2>
                <p>
                  Establishing a farm-to-table logistics network for a cooperative of 50 local
                  organic farmers. The goal was to minimize time from harvest to retail shelf.
                </p>
                <h3>Implementation</h3>
                <p>
                  Our team implemented a synchronized fleet management system using electric trucks
                  and a centralized distribution warehouse with automated sorting.
                </p>
                <h3>Impact</h3>
                <ul>
      ...
      default:
        return isAuthenticated ? (
          ...
          <AgroLogisticRedesigned onNavigate={handleNavigate} />
        );
    }
  };
      ...
      {showSidebar ? (
        <div className="relative h-[calc(100vh-4rem)] md:flex">
          ...
          <main className="w-full md:flex-1 overflow-y-auto bg-[#F6F7F9]">
            <div className="mx-auto p-6 max-w-7xl">{renderContent()}</div>
          </main>
        </div>
      ) : (
