    ...
    <div className="flex flex-col h-full bg-card/40 backdrop-blur-xl rounded-[40px] overflow-hidden border border-border shadow-2xl transition-all hover:bg-card/50">
      ...
      <div className="p-8 border-b border-border bg-foreground/5 space-y-4">
         <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
               ...
               <div>
                  <h3 className="text-sm font-black text-foreground uppercase tracking-tighter">Analytique Opérationnelle</h3>
                  <p className="text-[10px] text-muted-foreground font-black uppercase tracking-widest">Insights & Prédictions ML</p>
               </div>
            </div>
      ...
      <div className="flex-1 p-8 space-y-8 overflow-y-auto scrollbar-thin scrollbar-thumb-foreground/10">
         ...
         <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-foreground/5 p-5 rounded-[28px] border border-border">
               <div className="flex items-center gap-2 mb-2 text-primary">
                  ...
                  <span className="text-[9px] font-black uppercase tracking-widest">Efficiency Sc.</span>
               </div>
         ...
         <div className="space-y-4">
            <div className="flex items-center justify-between">
               <h4 className="text-[10px] font-black text-foreground uppercase tracking-[0.2em]">Évolution des Délais</h4>
         ...
         <div className="space-y-4">
            <div className="flex items-center justify-between">
               <h4 className="text-[10px] font-black text-foreground uppercase tracking-[0.2em]">Volume Prévisionnel</h4>
               <span className="text-[9px] text-primary font-black uppercase tracking-tighter">ML_ENGINE: ON</span>
            </div>
                  ...
                  <BarChart data={PERFORMANCE_DATA.slice(-4)}>
                     <Bar dataKey="volume" radius={[4, 4, 0, 0]}>
                        {PERFORMANCE_DATA.slice(-4).map((entry, index) => (
                           <Cell key={`cell-${index}`} fill={index === 3 ? '#3b82f6' : 'rgba(255,255,255,0.1)'} />
                        ))}
                     </Bar>
                  </BarChart>
               </ResponsiveContainer>
