...
export function useOverviewMetrics() {
  const [metrics, setMetrics] = useState<OverviewMetrics>({
    ...
    activities: [
      { id: '1', type: 'order', title: 'Nouvelle commande #TR-9421', user: 'Aminata K.', timestamp: 'Il y a 2m', amount: '45,000 FCFA' },
      { id: '2', type: 'registration', title: 'Nouveau producteur inscrit', user: 'GIE Samba', timestamp: 'Il y a 5m' },
      { id: '3', type: 'system', title: 'Mise à jour noyau logistique v2.1.0', user: 'System', timestamp: 'Il y a 12m' },
      { id: '4', type: 'security', title: 'Tentative de connexion bloquée', user: 'IP 192.168.x.x', timestamp: 'Il y a 15m' },
    ]
  });
