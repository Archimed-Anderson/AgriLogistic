...
const partners = [
  { name: "AgriSupply", logo: <Landmark className="h-6 w-6" />, color: "text-blue-600", bg: "bg-blue-50" },
  { name: "GlobalFarm", logo: <Globe className="h-6 w-6" />, color: "text-emerald-600", bg: "bg-emerald-50" },
  { name: "EcoLogistics", logo: <Leaf className="h-6 w-6" />, color: "text-lime-600", bg: "bg-lime-50" },
  { name: "SmartMarket", logo: <Zap className="h-6 w-6" />, color: "text-orange-600", bg: "bg-orange-50" },
  { name: "TechHarvest", logo: <Landmark className="h-6 w-6" />, color: "text-indigo-600", bg: "bg-indigo-50" },
  { name: "BioTrade", logo: <Factory className="h-6 w-6" />, color: "text-rose-600", bg: "bg-rose-50" },
]
      ...
      <div className="container px-6 mx-auto relative z-10">
        ...
        <div className="flex flex-col items-center mb-16">
          ...
          <p className="text-center text-slate-400 font-bold max-w-lg leading-relaxed">
            Ils nous font confiance pour sécuriser et optimiser leur chaîne d'approvisionnement agricole à l'échelle mondiale.
          </p>
        </div>
            ...
            {[...partners, ...partners].map((partner, idx) => (
              ...
              >
                ...
                <div className="flex flex-col mt-0.5">
                  <span className="text-lg font-black text-slate-900 tracking-tight">{partner.name}</span>
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Partenaire Certifié</span>
                </div>
              </div>
            ))}
          </div>
