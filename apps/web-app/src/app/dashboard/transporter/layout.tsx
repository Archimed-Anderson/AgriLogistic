...
const menuItems = [
  ...
  {
    icon: Navigation2,
    label: 'Optimizer Engine',
    href: '/dashboard/transporter/optimizer',
    badge: 'Live',
  },
  ...
  return (
    <div className="flex h-screen bg-[#020617] text-slate-200 overflow-hidden font-sans selection:bg-emerald-500/30">
      ...
      >
          ...
          <AnimatePresence>
            {isSidebarOpen && (
              ...
              >
                ...
                <span className="text-[8px] font-black tracking-[0.3em] uppercase opacity-40 group-hover:opacity-100 transition-opacity text-emerald-500">
                  Command Center
                </span>
              </motion.div>
            )}
        ...
        <div className="p-4 space-y-2 border-t border-white/5">
          <Link
            ...
            className="flex items-center gap-3 p-3 rounded-xl text-slate-400 hover:bg-white/5 hover:text-white transition-all"
          >
      ...
      <div className="flex flex-col flex-1 min-w-0 bg-[#020617] relative">
          ...
          <div className="flex items-center gap-8 flex-1">
            <div className="flex items-center gap-4 bg-slate-900/40 p-1 rounded-2xl border border-white/5">
              <div className="flex items-center gap-2 px-4 py-2 bg-emerald-500/10 rounded-xl border border-emerald-500/20">
                ...
                <div className="flex flex-col">
                  <span className="text-[8px] font-black uppercase text-emerald-500/60 leading-none">
                    MQTT Status
                  </span>
            ...
            <div className="hidden xl:flex items-center gap-4 bg-slate-900/40 px-6 py-2 rounded-2xl border border-white/5">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm font-black text-slate- font-mono">
                  14.829,00 <span className="text-orange-500">€</span>
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="relative group">
              <Button
                variant="ghost"
                size="icon"
                className="rounded-xl hover:bg-white/5 relative border border-white/5"
              >
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className="flex items-center gap-3 px-2 rounded-2xl hover:bg-white/5 border border-white/5"
                >
              ...
              <DropdownMenuContent
                align="end"
                className="w-64 rounded-2xl p-2 bg-slate-950 border-white/5 text-slate-200 shadow-3xl"
              >
        ...
        {/* Content Wrapper */}
        <main className="flex-1 overflow-auto bg-[#020617] p-8 custom-scrollbar">{children}</main>
      </div>
