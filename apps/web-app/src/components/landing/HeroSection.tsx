          ...
          <div className="lg:col-span-6 xl:col-span-7 space-y-10 animate-fade-in-up">
            ...
            <div className="space-y-6">
              ...
              <p className="max-w-xl text-lg md:text-xl text-muted-foreground/90 leading-relaxed font-medium">
                AgriLogistic déploie une intelligence de pointe pour transformer vos données
                agricoles en leviers de rentabilité immédiate. Une vision 360Â° sur votre chaîne de
                valeur.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5 pt-4">
              <Link href="/register" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full sm:w-auto h-16 px-10 text-lg font-black transition-all hover:scale-[1.02] active:scale-95 shadow-[0_20px_40px_-15px_rgba(45,90,39,0.3)] rounded-2xl bg-primary hover:bg-primary/95 border-b-4 border-primary-foreground/10"
                >
                  Démarrer Maintenant
              ...
              <Link href="/request-demo" className="w-full sm:w-auto">
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full sm:w-auto h-16 px-10 text-lg font-bold transition-all hover:bg-white hover:border-primary/30 rounded-2xl border-2 border-primary/10 backdrop-blur-sm group bg-white/40"
                >
            ...
            <div className="pt-12 flex flex-wrap gap-10 md:gap-16 items-center">
              <div className="group cursor-default">
                <p className="text-4xl font-black text-primary tracking-tighter group-hover:scale-110 transition-transform origin-left">
                  150k+
                </p>
                    ...
                    {[1, 2, 3, 4, 5].map((i) => (
                      <div key={i} className="h-1.5 w-6 rounded-full bg-primary/10 overflow-hidden">
                        <div
                          ...
                          style={{ width: `${20 * i}%`, animationDelay: `${i * 0.2}s` }}
                        />
                      </div>
                    ))}
                  </div>
