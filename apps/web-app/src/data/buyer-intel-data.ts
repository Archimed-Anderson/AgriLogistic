  ...
  negotiationHistory: [
    {
      ...
      text: 'Bonjour, nous confirmons la disponibilité des 50T de Maïs Grade A.',
      time: '10:30',
      type: 'received',
    },
    {
      id: 2,
      sender: 'Me',
      text: 'Le prix de 245$/T est au-dessus du marché spot (238$). Pouvez-vous ajuster ?',
      time: '10:32',
      type: 'sent',
    },
    {
      id: 3,
      sender: 'Coopérative Vallée',
      text: 'Nous pouvons descendre à 240$ si le paiement est sécurisé via Escrow 48h.',
      time: '10:33',
      type: 'received',
    },
  ],
