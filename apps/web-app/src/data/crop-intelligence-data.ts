...
export const cropZonesData: CropZone[] = [
  {
    ...
    satelliteImage: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=1200&h=800&fit=crop&q=80&auto=format', // Aerial farmland Africa
  ...
  },
  {
    ...
    satelliteImage: 'https://images.unsplash.com/photo-1447069387593-a5de0862481e?w=1200&h=800&fit=crop',
  ...
  },
  {
    ...
    satelliteImage: 'https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=1200&h=800&fit=crop&q=80&auto=format', // Corn field drone view
  ...
  },
  {
    ...
    satelliteImage: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=1200&h=800&fit=crop&q=80&auto=format', // Tropical agriculture Africa
  ...
  },
  {
    ...
    satelliteImage: 'https://images.unsplash.com/photo-1595278069441-2cf29f8005a4?w=1200&h=800&fit=crop&q=80&auto=format', // Cotton field aerial
    aiInsight: 'Stress hydrique détecté. Augmentation irrigation urgente recommandée.',
    location: {
      region: 'Nord, Cameroun',
      coordinates: { lat: 9.3000, lng: 13.3833 }
    },
    area: 3200,
  ...
  },
  {
    ...
    satelliteImage: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=1200&h=800&fit=crop&q=80&auto=format', // Aerial view wheat field
  ...
  },
  {
    ...
    satelliteImage: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=1200&h=800&fit=crop&q=80&auto=format', // Green landscape
  ...
  },
  {
    ...
    satelliteImage: 'https://images.unsplash.com/photo-1560493676-04071c5f467b?w=1200&h=800&fit=crop&q=80&auto=format', // Agriculture technology drone
  ...
  },
  {
    ...
    satelliteImage: 'https://images.unsplash.com/photo-1492496913980-501348b61469?w=1200&h=800&fit=crop&q=80&auto=format', // Rice paddy aerial
  ...
  },
  {
    ...
    satelliteImage: 'https://images.unsplash.com/photo-1589923188900-85dae523342b?w=1200&h=800&fit=crop&q=80&auto=format', // Corn field technology
...
export function getCropStatistics() {
  ...
  const avgHealthScore = cropZonesData.reduce((sum, zone) => sum + zone.healthScore, 0) / totalZones
  ...
  const warningZones = cropZonesData.filter(zone => zone.healthScore >= 50 && zone.healthScore < 70).length
  ...
  return {
    ...
    warningZones,
    healthyZones,
    totalEstimatedYield: cropZonesData.reduce((sum, zone) => sum + (zone.estimatedYield * zone.area), 0)
  }
}
