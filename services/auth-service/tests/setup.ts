...
const useDockerDefaults = (process.env.USE_DOCKER_DEFAULTS || 'true').toLowerCase() !== 'false';
if (useDockerDefaults) {
  process.env.DB_HOST = 'localhost';
  // Docker maps container 5432 -> host POSTGRES_PORT (default 5433 in our compose)
  process.env.DB_PORT = process.env.DB_PORT || '5433';
  process.env.DB_NAME = 'agrodeep_auth';
  process.env.DB_USER = 'agrodeep';
  process.env.DB_PASSWORD = 'agrodeep_secure_2026';
  ...
  process.env.DB_NAME = process.env.DB_NAME || 'agrodeep_auth';
  process.env.DB_USER = process.env.DB_USER || 'agrodeep';
  process.env.DB_PASSWORD = process.env.DB_PASSWORD || 'agrodeep_secure_2026';
  process.env.REDIS_HOST = process.env.REDIS_HOST || 'localhost';
  process.env.REDIS_PORT = process.env.REDIS_PORT || '6379';
  process.env.REDIS_PASSWORD = process.env.REDIS_PASSWORD || 'redis_secure_2026';
