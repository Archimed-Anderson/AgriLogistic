...
const testimonials = [
  {
    content: "Cette plateforme a transformé notre gestion quotidienne. La marketplace nous permet de vendre nos récoltes au meilleur prix garantis.",
    author: "Jean Dupont",
    role: "Propriétaire de Ferme",
    rating: 5,
  },
  {
    content: "L'outil de logistique est incroyablement précis. Nous avons réduit nos coûts de transport de 25% en utilisant AgroLogistic.",
    author: "Sophie Marceau",
    role: "Directrice Logistique",
    rating: 5,
  },
  {
    content: "Les prévisions IA sont justes et nous aident à mieux planifier nos cultures. Un outil indispensable pour l'agriculture moderne.",
            ...
            >
              ...
              <div className="flex items-center gap-4">
                 ...
                 <div>
                    ...
                    <p className="text-slate-400 text-xs uppercase tracking-wide">{testimonial.role}</p>
                 </div>
              </div>
            </div>
          ))}
