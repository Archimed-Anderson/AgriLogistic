...
const caseStudies = [
  {
    id: 1,
    title: "Une bouée de sauvetage numérique pour les agriculteurs : Comment nous avons construit la résilience climatique en Afrique de l'Ouest",
    excerpt: "Les petits exploitants agricoles d'Afrique de l'Ouest sont le pilier de la région, mais leurs moyens de subsistance sont constamment menacés par les conditions météorologiques extrêmes.",
  ...
  {
    id: 2,
    title: "Promouvoir la transparence et la visibilité dans la supply chain pour une entreprise suisse de commerce équitable",
    excerpt: "Digitaliser et standardiser les opérations multi-pays et promouvoir la transparence et la visibilité pour le commerce mondial.",
    category: "Étude de Cas",
  ...
  {
    id: 3,
    title: "Numérisation de la chaîne de valeur du cacao avec une multinationale américaine leader de la confiserie",
    excerpt: "Favoriser un engagement efficace avec les producteurs de cacao en encourageant l'adoption de pratiques durables.",
    category: "Étude de Cas",
  ...
  {
    id: 4,
    title: "Autonomiser les principaux meuniers du Nigeria avec une solution agricole basée sur l'intelligence profonde",
    excerpt: "Détection des cultures et estimation des superficies via l'analyse des données d'observation de la Terre.",
    category: "Étude de Cas",
  ...
  {
    id: 5,
    title: "Solution numérique pour l'approvisionnement en soja avec une société multinationale de négoce",
    excerpt: "Optimisation de l'approvisionnement en matières premières grâce à des solutions numériques avancées.",
    category: "Étude de Cas",
  ...
  {
    id: 6,
    title: "Une révolution numérique dans l'agriculture africaine : combler le fossé pour les petits exploitants",
    excerpt: "Transformer les pratiques agricoles traditionnelles grâce à la technologie moderne pour améliorer les rendements.",
    category: "Étude de Cas",
  ...
  },
  {
    ...
    excerpt: "Accompagner la transition vers des pratiques agricoles plus durables et responsables.",
    category: "Étude de Cas",
  ...
  {
    id: 8,
    title: "Intégration des données pour des insights en temps réel : produire des semences résilientes",
    excerpt: "Unifier les sources de données pour permettre des décisions agricoles éclairées et rapides.",
    category: "Étude de Cas",
  ...
  },
  {
    ...
    excerpt: "Débloquer la croissance en adoptant les solutions technologiques adaptées au secteur alimentaire.",
    category: "Blog",
  ...
  },
  {
    ...
    excerpt: "Améliorer la vie des agriculteurs grâce à des outils numériques accessibles et efficaces.",
    category: "Étude de Cas",
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 mb-12">
            <div>
              ...
              <p className="text-gray-600 text-lg max-w-2xl">
                Découvrez comment les entreprises agricoles du monde entier adoptent la transformation digitale 
                pour améliorer leur efficacité, leur durabilité et leur rentabilité.
              </p>
            </div>
      ...
      <section className="pb-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-2 mt-16">
            <button className="w-10 h-10 rounded-full bg-[#79C25C] text-white font-bold shadow-lg">1</button>
            <button className="w-10 h-10 rounded-full bg-white border border-gray-200 text-gray-600 hover:border-[#79C25C] hover:text-[#79C25C] transition-colors">2</button>
            <button className="w-10 h-10 rounded-full bg-white border border-gray-200 text-gray-600 hover:border-[#79C25C] hover:text-[#79C25C] transition-colors">3</button>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-[#002C17] to-[#004D2C] text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-gray-300 text-lg mb-10 max-w-2xl mx-auto leading-relaxed">
            Rejoignez les leaders du secteur qui utilisent nos solutions numériques 
            pour révolutionner leurs opérations agricoles.
          </p>
