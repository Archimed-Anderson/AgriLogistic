...
import { Truck, Map as MapIcon, Calendar, Filter, Plus } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-lg font-black tracking-tighter text-foreground uppercase">
              Centre d'Opérations Flotte
            </h2>
            <p className="text-[10px] text-muted-foreground font-black uppercase tracking-widest">
              {vehicles.length} Véhicules en temps réel
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            className="rounded-xl border-border bg-card/40 backdrop-blur-md h-10 gap-2 shadow-sm uppercase text-[10px] font-black tracking-widest"
          >
        ...
        <div className="lg:col-span-4 space-y-6 flex flex-col">
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-[32px] p-6">
            ...
            <p className="text-[10px] text-muted-foreground leading-relaxed font-medium capitalize">
              Retard détecté sur l'axe Thiès - Dakar. Ralentissement majeur par congestion.{' '}
              <span className="text-primary font-black ml-1">+25min</span>
            </p>
          </div>
        </div>
      </div>
